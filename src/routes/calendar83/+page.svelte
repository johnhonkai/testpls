            ...
            <div class="w-[1215px] rounded-lg bg-linear-to-b from-amber-500 to-amber-100 ">
                ...
                <div class="relative grid grid-cols-9 gap-1  h-[55px] pe-1 overflow-x-clip ">
                    ...
                    <div on:click={() => openModal("")} class=" col-span-2 will-change-transform transform transition-transform hover:scale-105 cursor-pointer relative my-0.5 bg-gray-100 text-black font-semibold text-center items-center justify-center border-2 border-amber-700">
                        ...
                        <div class="absolute right-0 top-1/2 transform -translate-y-1/2 w-16 h-full">
                            <img src="https://i.imgur.com/TwskvYg.png" alt="PS" class="w-full h-full object-cover rounded-md" />
                        </div>
                    </div>    

                    <div on:click={() => openModal("Valk3")} class=" col-span-2 will-change-transform transform transition-transform hover:scale-105 cursor-pointer relative my-0.5 bg-gray-100 text-black font-semibold text-center items-center justify-center border-2 border-amber-700">
                ...
                <div class="relative grid grid-cols-9 gap-1  h-[55px] pe-1 overflow-x-clip">
                    ...
                    <div on:click={() => openModal("Equip")} class="col-span-2 will-change-transform transform transition-transform hover:scale-105 cursor-pointer relative my-0.5 bg-gray-100 text-black font-semibold text-center items-center justify-center border-2 border-amber-700">
                        <!-- Centered Text -->
                        <span class="absolute inset-0 flex items-center justify-center z-10">PS Equipment</span>
    ...
    <div class="overflow-x-auto ">
        <div class="w-[1215px]  bg-linear-to-b from-amber-500 to-amber-100 ">
            ...
            <div class="relative grid grid-cols-9 gap-1 h-[55px] pe-1 overflow-x-clip">
                ...
                <div class="col-span-2"></div>
                <div on:click={() => openModal("")} class="col-span-6 will-change-transform transform transition-transform hover:scale-105 ease-linear cursor-pointer relative my-0.5  bg-gray-100 text-black font-semibold text-left items-center justify-center border-2  border-amber-700">
                    <!-- Centered Text -->
                    <span class="absolute px-2.5 leading-4 inset-0 flex items-center justify-left">P2 Ch 9: If Destiny Concludes Today</span>
                    <!-- Image positioned on the right side -->
                    <div class="absolute right-0 top-1/2 transform -translate-y-1/2 w-48 h-full">
                        <img src="https://i.imgur.com/klU9OYx.png" alt="Event 1" class="w-full h-full object-cover " />
                    </div>
                </div>
             ...
             <div class="relative grid grid-cols-9 gap-1 h-[55px] pe-1 overflow-x-clip">
                ...
                <div on:click={() => openModal("")} class="col-span-5 will-change-transform transform transition-transform hover:scale-105 ease-linear cursor-pointer relative my-0.5  bg-gray-100 text-black font-semibold text-left items-center justify-center border-2  border-amber-700">
                    <!-- Centered Text -->
                    <span class="absolute px-2.5 leading-4 inset-0 flex items-center justify-left">Plan the Future Event</span>
                    <!-- Image positioned on the right side -->
                    <div class="absolute right-0 top-1/2 transform -translate-y-1/2 w-48 h-full">
                        <img src="https://i.imgur.com/feeZC3C.png" alt="Event 1" class="w-full h-full object-cover " />
                    </div>
                </div>
        ...
        <div class="w-[940px] rounded-lg bg-gray-900 text-white" >
            ...
            <div class="grid grid-cols-6 gap-1 items-center bg-slate-100 text pt-1 pb-1 pe-2 " >
                ...
                <BossCard image="/images/Bosses/Sprout_of_Wishing_SSS.webp" date="Jul 7" weather="Type" bosspage="/boss?typesprout" />
                    ...
                    <div class="flex col-span-3 justify-center gap-1 ml-2">
                        <BossCard image="/images/Bosses/Lantern_Tsavorae_SSS.webp" date="Jul 8"  />
            ...
            <div class="grid grid-cols-6 gap-1 items-center bg-slate-100 text pt-1 pb-1 pe-2 " >
                ...
                <BossCard image="/images/Bosses/Parvati.webp" date="Jul 14" weather="Extreme" bosspage="/boss?extreme-parvati" />
                </div>
            ...
            <div class="grid grid-cols-6 gap-1 items-center bg-slate-100 text pt-1 pb-1 pe-2 " >
                ...
                <div class="flex col-span-2 justify-center gap-1 mr-2" >
                <BossCard image="/images/Bosses/Herrscher of Corruption.webp" date="Jul 18" weather="Bleed" bosspage="/boss?bleedhoc" />
            ...
            <div class="grid grid-cols-6 gap-1 items-center bg-slate-100 text pt-1 pb-1 pe-2 " >
                ...
                <BossCard image="/images/Bosses/Hellmaru.webp" date="Aug 4" weather="Ice" bosspage="/boss?icehellmaru" />
                    </div>
                     
                    <div class="flex col-span-3 justify-center gap-1 ml-2">
                    <BossCard image="/images/Bosses/epernay.png" date="Aug 5"  />
            ...
            <div class="grid grid-cols-6 gap-1 items-center bg-slate-100 text pt-1 pb-1 pe-2 " >
                ...
                <BossCard image="/images/Bosses/Sa_SSS.webp" date="Aug 18" weather="Stardust" bosspage="/boss?sa" />
                    </div>

                   <div class="flex col-span-3 justify-center gap-1 ml-2">
                    <BossCard image="/images/BossesMA/Argent Knight Artemis_SSS.webp" date="Aug 19"  />
