<svelte:head>
  <title>Law of Ascension</title> 
    ...
    <meta property="og:image" content="https://i.imgur.com/6eOeDMZ.png" />
    <meta property="og:url" content="https://marisaimpact.com/ar/law-of-ascension" />
    <meta property="og:type" content="website" />

    <meta name="twitter:card" content="summary_large_image">

    <link rel="canonical" href="https://marisaimpact.com/ar/law-of-ascension" />
</svelte:head>
...
async function captureStats() {
  ...
  link.download = `law-of-ascension.png`;
...
<section>
  ...
  <p class="text-sm sm:text-base text-gray-300 leading-relaxed sm:leading-loose mt-2">
    <span class="block ">
      <strong class="text-white">Law of Ascension</strong> is a QTE-focused Astral Ring. 
      <br/>
      Teammates with <span class="text-teal-400 font-medium">Heavenly Shift</span> tag can trigger leader's QTE, special attack Heavenly Shift, grant AR on QTE, and more.
    </span>
  </p>
</section>
