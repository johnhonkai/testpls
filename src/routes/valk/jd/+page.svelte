...
function selectTabMobile(event) {
  ...
  onMount(async () => {
    ...
    jdlikes = await (await import("$lib/firebaseLikes")).getLikesFromFirestore(charName); // Fetch current likes
  });
  ...
  async function increaseLike() {
    ...
    jdlikes = await likeWithVoterId(charName, voterId); // Like with voter ID tracking
              ...
              <tr>
                ...
                <td>
                  Leader Skill:<br/>
                    ...
                    - During AR Charging: Valk on the field gain Physical DMG +22% ➔ 251%
                    <br/>
