...
<section class="relative mx-auto flex flex-row items-center justify-center px-4 md:p-2 gap-3 md:pb-0  md:mt-0  pt-2	sm:pt-0	">
  ...
  <div class="flex flex-col items-center text-center justify-start">
    ...
    <p class="text-base md:text-md text-center md:block hidden text-slate-300 mb-2">Delta | Release Date: v4.3 (29 Oct 2020)  </p>
    ...
    <div class="w-full max-w-sm mb-2">
      ...
      <div class="flex flex-col items-center">
        <div class="flex w-[260px] md:w-[300px] gap-2 flex-wrap justify-center outline outline-pink-500 outline-1 bg-pink-950/75 rounded-lg p-2 backdrop-blur-sm">
  ...
  <div class="p-4 sm:p-4 bg-base-100 rounded-lg">
    ...
    <div>
        ...
        <p class="mt-4 text-sm sm:text-base">
          ...
          <br/>
          Fervent Tempo (FT) is an old Physical DPS with flashy neon effects.
      </p>
