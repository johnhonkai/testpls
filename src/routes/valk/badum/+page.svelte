...
<CharacterLayout
  charName="badum"
  initialLikes={likesData["badum"] || 0}
  accent="bg-red-800"
  image="/images/valkfull/bw.webp"
  alt="Ba-dum! Fiery Wishing Star"
...
<section class="max-w-[960px] mx-auto flex flex-col gap-1 sm:p-1 mb-6 ">
  ...
  <div class="p-4 sm:p-4 bg-base-100 rounded-lg">
      ...
      <div>
          ...
          <ul class="list-disc ml-6 text-sm sm:text-base">
                <li>Best support for Xentinel. HLE always use Badum support against SD enemies.</li>
                <li>Great support for other GoI teams.  </li>
          </ul>    
          ...
          <ul class="list-disc ml-6 text-sm sm:text-base">
                <li>Great support. Can trigger Domain Resonance very fast.</li>
                <li>WoP DPS always use Badum or HLE against SD enemies.</li>
          </ul>   
          <p class="mt-4 text-sm sm:text-base">
              <strong class="text-amber-400">Law of Ascension Support</strong> <br/>Good support for PS and RS, but has been used less now that better supports for them have appeared over time.
          ...
          <h2 class="text-xl font-semibold mb-2 text-left text-slate-100 cooltext">PULL RECOMMENDATION</h2>
            ...
            <p class="mt-4 text-sm sm:text-base">
                ...
                For some reason, Badum is still relevant as support. If you can afford it, Badum is okay to get, but not the highest priority over newer valks. 
            </p>
