...
function selectTabMobile(event) {
  ...
  onMount(async () => {
    ...
    simplikes = await (await import("$lib/firebaseLikes")).getLikesFromFirestore(charName); // Fetch current likes
  });
  ...
  async function increaseLike() {
    ...
    simplikes = await likeWithVoterId(charName, voterId); // Like with voter ID tracking
