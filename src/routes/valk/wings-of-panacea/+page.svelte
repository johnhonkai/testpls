...
<div class="grid gap-4 my-6 
  ...
  {/if}
     ...
     <div>
      ...
      <div class="flex shadow-md relative space-x-4 p-2 rounded-sm items-center w-fit  bg-linear-to-r from-purple-500/75 to-cyan-500/0 overflow-hidden">
        ...
        <div class="absolute z-0 w-auto h-full top-0 left-0 opacity-50 mix-blend-overlay ">
          ...
          <div class="flex flex-col space-y-2 pr-2 z-10">
            <p class="text-sm sm:text-lg text-slate-100"> <b>Start:</b> Pure Wish</p>
            <p class="text-sm sm:text-lg text-slate-100"> <b>Optional:</b> Quiet Caress </p>
          </div>
        </div>
      ...
      <p class="text-sm sm:text-base text-center sm:text-left">
       As usual, takes more real-life time to clear since you have to watch SO and ult animations multiple times. There is another variation where you stay in Stellar Outburst longer (Earnest Warmth signet instead of Refreshing Spirit).
      </p>
      ...
      <div class="flex shadow-md relative space-x-4 p-2 rounded-sm items-center w-fit  bg-linear-to-r from-purple-500/75 to-cyan-500/0 overflow-hidden">
        ...
        <div class="absolute z-0 w-auto h-full top-0 left-0 opacity-50 mix-blend-overlay ">
          ...
          <!-- Right side text sections -->
          <div class="flex flex-col space-y-2 pr-2 z-10">
            <p class="text-sm sm:text-lg text-slate-100"> <b>Start:</b> Heartfelt Words ➔ Refreshing Spirit </p>
            <p class="text-sm sm:text-lg text-slate-100"> <b>Optional:</b> Quiet Caress </p>
          </div>
        </div>
        ...
        <div class="mt-3 rounded-sm" >
          ...
          <li class="text-sm sm:text-base"> Normal mode: You can complete the run with just one Ego signet (Heartfelt Words), but having both Ego signets is a big improvement. You can get both Ego signets at the start by using Thorny Crown sigil, OR by resetting Floor 1 until you get another Ego portal, OR use Because of You support sigil and get the other two Ego signets on Floor 7.</li>
          </ul>
          </div>
