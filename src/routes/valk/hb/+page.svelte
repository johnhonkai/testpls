...
<svelte:head>
  <title>Bronya - Haxxor Bunny</title> 

    <meta property="og:title" content="Bronya - Haxxor Bunny"/>
    <meta property="og:description" content="Haxxor Bunny Guide, Builds and Gameplay" />
    <meta property="og:image" content="" />
    <meta property="og:url" content="https://marisaimpact.com/valk/hb" />
...
function selectTabMobile(event) {
  ...
  let celikes = likesData["hb"] || 0; // Get initial likes from JSON
  const charName = "hb"; // Route name for this character
...
<div class="relative  w-auto h-48 sm:h-60 md:h-72 flex justify-center " id="valkpicbox">
  ...
  <img src="/images/valkfull/hb.webp" alt="Sparkle" class="h-full w-auto object-cover md:object-contain  " style ="view-transition-name: valkyrie-image-41;"/> 
...
<div class="flex flex-col items-center text-center justify-start">
  ...
  <div>
  <h1 class="text-xl md:text-2xl text-slate-100 font-bold text-center leading-4 mb-4 sm:mb-0">Haxxor Bunny</h1>
</div>
  <!-- Character Name and Release Date -->
  <p class="text-base md:text-md custom-font mb-2 text-center tracking-wider sm:block hidden text-slate-100">Bronya | Release Date: v4.7 (22 Apr 2021)
  ...
  <div class="p-4 sm:p-4 bg-base-100 rounded-lg">
      ...
      <div>
          ...
          <p class="text-sm sm:text-base mt-4">
              <b class="text-amber-400">Outdated P1 Ice Support</b><br/> 
              Haxxor Bunny (HB) summons drones and provides buffs while off-field.
          ...
          <p class="mt-4 text-sm sm:text-base">
              <b class="text-amber-400">New Players on Haxxor Bunny</b>
          ...
          <p class="mt-4 text-sm sm:text-base mb-2">
            <b class="text-amber-400">New Players on Haxxor Bunny Equipment</b><br/> 
            
        <ul class="list-disc ml-6 text-sm sm:text-base">

          <li class="mt-2"> G3 Turgenev stigma is farmable in Foundry, but will take a couple of weeks. Turgenev Top and Bottom are really good - they can be used by other Part 1 Elemental supports.</li>
          <li class="mt-2"> Only use your crystal to pull Part 2 valkyries, since they use a new Astral Ring system. If Crusher 19-C  is available through other means, such as spending event or Battle Pass, you can consider getting it that way.
          ...
          <ul class="list-disc ml-6 text-sm sm:text-base ">
              <li ><strong>Haxxor Bunny:</strong> Asterite Shop, Open World Task</li>
              <li><strong>G3 Turgenev Stigma:</strong> Foundry </li>
              <li><strong>Crusher 19-C:</strong> Focused Supply </li>
      ...
      <div>
              ...
              <div class="flex flex-wrap my-2 rounded-lg overflow-hidden w-fit gap-1">
                ...
                <div class="w-20 h-20 sm:w-28 sm:h-28">
                  <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/10/75940953/77320418effa6ff3d1790aeb0f55a168_3207378781567744513.png?x-oss-process=image/quality,q_75/resize,s_120" alt="Vita" class="w-full h-full object-cover">

                </div>

                <div class="w-20 h-20 sm:w-28 sm:h-28">
                  <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/24/75216984/f2e785b423273338556e66771a543a69_5615190248057583714.png?x-oss-process=image/quality,q_75/resize,s_120" alt="Vita" class="w-full h-full object-cover">

                </div>

                <div class="w-20 h-20 sm:w-28 sm:h-28">
                  <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/24/75216984/678232c05c978cdfc8f6c8020ba7e27f_1503084313692764393.png?x-oss-process=image/quality,q_75/resize,s_120" alt="Vita" class="w-full h-full object-cover">

                </div>

                <div class="w-20 h-20 sm:w-28 sm:h-28">
                  <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/24/75216984/73531d5b12f1133e5f5f926f1cf14b0b_2678839856354413010.png?x-oss-process=image/quality,q_75/resize,s_120" alt="Vita" class="w-full h-full object-cover">

                </div>
              </div>  
              <h4 class="text-base sm:text-base text-white">Crusher Bunny 19C + Turgenev set</h4>
              </div>


              <div class="p-4 mt-4 bg-linear-to-r from-blue-950/75 to-blue-900/75 rounded-sm">
                <p class="text-sm sm:text-base text-left mb-4">
                  <b>Crusher Bunny 19C </b><br/>One of the best weapons for Haxxor Bunny, but not mandatory for her to function.

                </p>

                <p class="text-sm sm:text-base text-left mb-4">
                  <b>G3 Turgenev set</b><br/> - Best set for Haxxor Bunny. Has buffs for the team and summoned units.
              ...
              <div class="flex flex-col justify-center items-center">
                ...
                <h4 class="text-base sm:text-base text-white">Falcon Flare</h4>
                </div>

              <div class="p-4 mt-4 bg-linear-to-r from-blue-950/75 to-blue-900/75 rounded-sm">
                <p class="text-sm sm:text-base text-left">
                  In fast rotations, 19C active might still be in cd when HB uses QTE + Ult. In these situtaions, Falcon Flare is better than 19C, since Falcon Flare's passive skill [20% Ice Taken] has no cooldown.
                </p>
              </div>
  
  
                <div class="divider  "></div>
                <h2 class="text-xl font-semibold text-center  text-blue-400">OTHER STIGMA OPTION</h2>
