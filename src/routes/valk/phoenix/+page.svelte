...
<svelte:head>
    <title>Fu Hua - Phoenix</title> 
    <meta property="og:title" content="Fu Hua - Phoenix" />
    <meta property="og:description" content="Fu Hua - Phoenix Guide, Builds and Gameplay" />
    <meta property="og:image" content="https://i.imgur.com/OXoSovv.png" />
    <meta property="og:url" content="https://marisaimpact.com/valk/phoenix" />
...
<CharacterLayout
  charName="Phoenix"
  initialLikes={likesData["Phoenix"] || 0}
  accent="bg-red-800"
  image="/images/valkfull/Phoenix.png"
  alt="Phoenix"
  ...
  releaseEN="v2.2.5 (28 Sep 2018)"
  releaseCN="v2.2 (29 Mar 2018)"  

>
  <!-- Tags / Type Row -->
  <CharBio mode="dps" rank="s" type="psy" element="fire"  bg="bg-red-800"/>
  <CharBio mode="support" ar={['p1fire', 'p1ice' , 'p1lightning']} bg="bg-red-800" />
  ...
  <div class="p-4 sm:p-4 bg-base-100 rounded-lg">
    ...
    <div>
        ...
        <p class="mt-4 text-sm sm:text-base">
          <strong class="text-amber-400">Phoenix is the hottest thing there is!</strong>
          <br/>
          
          
      </p>
        <ul class="list-disc ml-6 text-sm sm:text-base ">
          <li> Phoenix (PX) was a good elemental support that can dish out decent damage. She was meta in both Arena and Abyss.</li>
          <li> PX could also be used as a decent DPS with the proper equipment. </li>
          <li> PX launches different attacks based on your punch and kick inputs.</li>
        ...
        <p class="mt-4 text-sm sm:text-base">
          ...
          <br/>
You can farm PX in War Treasury. All valks in War Treasury are outdated, so you can unlock whoever you like first. Consider unlocking PX for Elysian Realm first-clear crystal rewards.
        ...
        <ul class="list-disc ml-6 text-sm sm:text-base ">
          <li ><strong>Phoenix:</strong> War Treasury, Dorm Supply, Battle Pass.</li>
          <li ><strong>Fenghuang Down / Nebulous Duality:</strong> Exchange Shop, Battle Pass.</li>
          <li ><strong>Little Joys / Fu Hua Margrave:</strong> Exchange Shop, Battle Pass.</li>
  ...
  {/if}
      ...
      <div>
              ...
              <div class="flex flex-wrap my-2 rounded-lg overflow-hidden w-fit gap-1">
                ...
                <div class="w-20 h-20 sm:w-28 sm:h-28">
                  <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/07/72350798/49af15ff2079750b65d08e8c3f1b45c7_1339011025260319947.png" alt="Path to Acheron" class="w-full h-full object-cover">
              </div>


              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/24/72350798/3c6878aa3f8374ec3c83c6fd10b0bd9a_6564133355238929343.png" alt="Cecilia Youth T" class="w-full h-full object-cover">

              </div>


              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/24/72350798/15dea92b7fb5cd87ad6627875a266385_2086045710242035639.png" alt="Cecilia Youth M" class="w-full h-full object-cover">

              </div>

              
              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/24/72350798/5945dff0282af271e16e57c7ad15a4ae_8855635232263599336.png" alt="Cecilia Youth B" class="w-full h-full object-cover">
            </div>

              </div>  
              <h4 class="text-base sm:text-base text-white"> Cosmic Duality + Fu Hua: Margrave set </h4>
              </div>
           ...
           <div class="divider"></div>
              ...
              <div class="flex flex-wrap my-2 rounded-lg overflow-hidden w-fit gap-1">
                ...
                <div class="w-20 h-20 sm:w-28 sm:h-28">
                  <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/07/72350798/f8f7c0425bb46f9c0855c4caa255ec23_2866868844230122139.png" alt="Path to Acheron" class="w-full h-full object-cover">
              </div>
              ...
              <h4 class="text-base sm:text-base text-white"> Oblivion Down + G4 Little Joys set </h4>
              </div>
           ...
           <div class="divider"></div>
              ...
              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/17/75216984/012ad384fa52f9af1158877fe68d0627_6876485860537502744.png" alt="Cecilia Youth T" class="w-full h-full object-cover">

              </div>


              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/17/75216984/20ba35b905a9ec935e2bf5afebb1f3e2_4013607394506114392.png" alt="Cecilia Youth M" class="w-full h-full object-cover">

              </div>

              
              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/17/75216984/07bf0f5b958d33e8ecc7aaca33d89762_7385354217905902692.png" alt="Cecilia Youth B" class="w-full h-full object-cover">
            </div>
      ...
      <div class=" gap-6 mt-5 mb-10">
        ...
        <div class="bg-gray-800 p-4 rounded-lg shadow-md">
          <h2 class="text-xl  font-semibold mb-4 text-left text-slate-100 cooltext">Arena</h2>
          ...
          <div class="relative overflow-hidden" style="padding-top: 56.25%;">
            ...
            loading="lazy" 
                ...
                src="https://www.youtube.com/embed/xjanIsoMjmw"
        ...
        <div class="bg-gray-800 p-4 rounded-lg shadow-md">
          ...
          <div class="relative overflow-hidden" style="padding-top: 56.25%;">
            ...
            loading="lazy" 
                ...
                class="absolute top-0 left-0 w-full h-full"
                src="https://www.youtube.com/embed/FEHlFReMOts"
                title="YouTube video player"
                frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen>
