...
<div class="flex flex-col items-center text-center justify-start mt-3">
  ...
  <p class="text-base md:text-md text-center md:block hidden text-slate-300">Bianka 'Durandal' Ataegina  </p>
...
<section class="max-w-[960px] mx-auto flex flex-col gap-1 sm:p-1 mb-6 ">
  ...
  {/if}
     ...
     <div>
      ...
      <div class="p-4 mt-4 bg-gradient-to-r from-teal-950/75 to-teal-900/75 rounded">
