...
<svelte:head>
  <title>Griseo - Starry Impression</title> 

    <meta property="og:title" content="Griseo - Starry Impression"/>
    <meta property="og:description" content="Starry Impression Guide, Builds and Gameplay" />
    <meta property="og:image" content="" />
    <meta property="og:url" content="https://marisaimpact.com/valk/si" />
...
function selectTabMobile(event) {
  ...
  let celikes = likesData["si"] || 0; // Get initial likes from JSON
  const charName = "si"; // Route name for this character
...
<div class="relative  w-auto h-48 sm:h-60 md:h-72 flex justify-center " id="valkpicbox">
  ...
  <img src="/images/valkfull/si.webp" alt="Sparkle" class="h-full w-auto object-cover md:object-contain  " style ="view-transition-name: valkyrie-image-27;"/> 
...
<div class="flex flex-col items-center text-center justify-start">
  ...
  <div>
  <h1 class="text-xl md:text-2xl text-slate-100 font-bold text-center leading-4 mb-4 sm:mb-0">Starry Impression</h1>
</div>
  <!-- Character Name and Release Date -->
  <p class="text-base md:text-md text-center md:block hidden text-slate-300 my-2">Griseo | Release Date: v5.8 (30 June 2022)
...
<section class="max-w-[960px] mx-auto flex flex-col gap-1 sm:p-1 mb-6 ">
  ...
  <div class="p-4 sm:p-4 bg-base-100 rounded-lg">
      ...
      <div>
          ...
          <p class="text-sm sm:text-base mt-4">
              <strong class="text-amber-400">P1 Physical Support, Bleed Applier</strong><br/> 
              Starry Impression (SI) provides Physical DMG buff and can inflict Bleed trauma. Currently, her roles are:
              <br/> - To support Cosmic Expression DPS
              <br/> - SI can be used by any team to counter enemies or stages that require bleed
              <br/> - SI is still used in Memorial Arena
          ...
          <p class="mt-4 text-sm sm:text-base">
              <strong class="text-amber-400">New Players on Starry Impression</strong>
              <br/> - Farm <a href="/valk/coralie" class="link ">Coralie Valkyrie Blastmetal</a>               first from Asterite Shop and Open World since she can fit in any Astral Ring team. If you have extra Asterite, then you can consider getting SI for Elysian Ream first-clear crystal rewards.
              <br/> - In Arena and Lv80+ Abyss, you will encounter enemies that have huge bleed trauma and effects that require bleed.  For new players, SI is one of the farmable options to reliably apply bleed.
          </p>


          <p class="mt-4 text-sm sm:text-base mb-2">
            <strong class="text-amber-400">New Players on Starry Impression Equipment</strong><br/> 
            Only use your crystal to pull Part 2 valkyries, since they use a new Astral Ring system. If SI's gears are available through other means, such as spending event or Battle Pass, you can consider getting them that way.
        </p>

          <p class="mt-4 text-sm sm:text-base">
              <strong class="text-amber-400">Competitive</strong><br/> SI is only used in Memorial Arena mode.
          </p>
          ...
          <ul class="list-disc ml-6 text-sm sm:text-base ">
              <li ><strong>SI:</strong> Asterite Shop, Open World Task</li>
              <li><strong>SI Equipment:</strong> Focused Supply </li>
          </ul>
          <div class="divider  "></div>
          <!-- Full Guide Section -->
          ...
          <div class="relative overflow-hidden" style="padding-top: 56.25%;">
            <iframe
                ...
                src="https://www.youtube.com/embed/XReNJjVGjIU"
  ...
  {/if}
      ...
      <div>
              ...
              <div class="flex flex-wrap my-2 rounded-lg overflow-hidden w-fit gap-1">
                ...
                <div class="w-20 h-20 sm:w-28 sm:h-28">
                  <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2022/06/01/50494840/30a84f96e752dfefd5c748bd0e3c60cc_884595812458030194.png?x-oss-process=image/quality,q_75/resize,s_120" alt="Vita" class="w-full h-full object-cover">

                </div>

                  <div class="w-20 h-20 sm:w-28 sm:h-28">
                    <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2022/06/01/50494840/e427c46de05df3202807e6dbc28966b4_8989151935889432114.png?x-oss-process=image/quality,q_75/resize,s_120" alt="Vita" class="w-full h-full object-cover">

                  </div>


                  <div class="w-20 h-20 sm:w-28 sm:h-28">
                    <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2022/06/01/50494840/573c960c651db5fccf0e62c346e8d694_6009956583496464822.png?x-oss-process=image/quality,q_75/resize,s_120" alt="Vita" class="w-full h-full object-cover">

                  </div>

                  
                  <div class="w-20 h-20 sm:w-28 sm:h-28">
                    <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2022/06/01/50494840/db44fac6bb8b32c22e17a825351673d2_4508064355194155989.png?x-oss-process=image/quality,q_75/resize,s_120" alt="Vita" class="w-full h-full object-cover">
                </div>

              </div>  
              <h4 class="text-base sm:text-base text-white">Elysian Astra + Cézanne set</h4>
              </div>


              <div class="p-4 mt-4 bg-linear-to-r from-cyan-950/75 to-cyan-900/75 rounded-sm">
                <p class="text-sm sm:text-base text-left mb-4">
                  <b>Elysian Astra </b><br/> Has two important utilities: <br/> - On QTE, auto-deploys cross and triggers evasion skill. 
                  <br/> - Applies Bleed.
                </p>
              
                <p class="text-sm sm:text-base text-left mb-4">
                  <b>Cézanne</b><br/> - Mid gives Bleed trauma +25%. Bot piece is strong, and is required to trigger 2PC buffs.
                  <br/> - Priority is B > TM.
                </p>
              ...
              <div class="flex flex-col justify-center items-center">
                <h2 class="text-xl font-semibold text-center  text-teal-400">For Supporting Part 2 Teams / All Purpose</h2>
                ...
                <div class="p-4 mt-4 bg-linear-to-r from-zinc-950/75 to-zinc-900/75 rounded-sm">
                  ...
                  <p class="text-sm sm:text-base text-left">
                    <b>Tsiolkovsky</b><br/> - Forgeable in Foundry
                    <br/> - Buffs are universal, so you can just forge this for Coralie, and you can use this for other Part 1 supports. Saves your mats!
                  </p>
                </div>
                <div class="divider  "></div>

              <div class="flex flex-col justify-center items-center">
                <h2 class="text-xl font-semibold text-center  text-amber-400 mb-1">For Supporting Part 1 Physical Teams</h2>
                ...
                <h4 class="text-base sm:text-base text-white">Shuijing TB, Mei: Beach M</h4>
                </div>
                ...
                <div class="p-4 mt-4 bg-linear-to-r from-zinc-950/75 to-zinc-900/75 rounded-sm">
                  ...
                  <p class="text-sm sm:text-base text-left mb-4">
                    <b>G3 Shuijing TB</b><br/> Forgeable in Foundry
                  </p>
                ...
                <div class="flex flex-col justify-center items-center">
                  ...
                  <div class="flex flex-wrap my-2 rounded-lg overflow-hidden w-fit gap-1">
                      ...
                      <div class="w-20 h-20 sm:w-28 sm:h-28">
                        <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/18/72350798/45e3b3468a514ebec826b80d62055ffe_5205761801982339067.png?x-oss-process=image/quality,q_75/resize,s_120" alt="Cecilia Youth T" class="w-full h-full object-cover">
    
                      </div>
    
    
                      <div class="w-20 h-20 sm:w-28 sm:h-28">
                        <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/17/91006211/52aa284287a7501e317f47736dd98731_5516986825915144922.png?x-oss-process=image/quality,q_75/resize,s_120" alt="Cecilia Youth M" class="w-full h-full object-cover">
    
                      </div>
    
                      
                      <div class="w-20 h-20 sm:w-28 sm:h-28">
                        <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/30/50494840/56f4ab9ee5385854f1a269b5d2eeb04e_8243144226193484159.png?x-oss-process=image/quality,q_75/resize,s_120" alt="Cecilia Youth B" class="w-full h-full object-cover">
                    </div>
    
                  </div>  
                  <h4 class="text-base sm:text-base text-white">Tesla Band T, Beethoven M, Ogier B</h4>
                  </div>
                  ...
                  <div class="p-4 mt-4 bg-linear-to-r from-zinc-950/75 to-zinc-900/75 rounded-sm">
                    ...
                    <p class="text-sm sm:text-base text-left mb-4">
                      <b>G2 Tesla Band T</b><br/> Forgeable in Foundry
                    </p>

                    <p class="text-sm sm:text-base text-left mb-4">
                      <b>G2 Beethoven M</b><br/> Forgeable in Foundry
                    </p>
                    
                    <p class="text-sm sm:text-base text-left ">
                      <b>Ogier B</b><br/> Forgeable in Foundry
                    </p>
                ...
                <div class="flex flex-col justify-center items-center">
                  ...
                  <div class="flex flex-wrap my-2 rounded-lg overflow-hidden w-fit gap-1">
                      ...
                      <div class="w-20 h-20 sm:w-28 sm:h-28">
                        <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/17/75216984/db66db838b9cdd7b8f20180f5a68f4fa_6021620429428844128.png?x-oss-process=image/quality,q_75/resize,s_120" alt="Cecilia Youth T" class="w-full h-full object-cover">
    
                      </div>
    
    
                      <div class="w-20 h-20 sm:w-28 sm:h-28">
                        <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/17/75216984/09cb4dfbe5519a137facc4cbbb0c7b2b_1205783264132674828.png?x-oss-process=image/quality,q_75/resize,s_120" alt="Cecilia Youth M" class="w-full h-full object-cover">
    
                      </div>
    
                      
                      <div class="w-20 h-20 sm:w-28 sm:h-28">
                        <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/17/75216984/38ff3c82b1487b76c243bdbe9e33ed32_6832847059901548676.png?x-oss-process=image/quality,q_75/resize,s_120" alt="Cecilia Youth B" class="w-full h-full object-cover">
                    </div>
    
                  </div>  
                  <h4 class="text-base sm:text-base text-white">Holmes TB / MB</h4>
                  </div>
                  ...
                  <div class="p-4 mt-4 bg-linear-to-r from-zinc-950/75 to-zinc-900/75 rounded-sm">
                    ...
                    <p class="text-sm sm:text-base text-left ">
                      <b>G3 Holmes</b><br/> - Forgeable in Foundry
                      <br/> - Use TB or MB with other stigmas shown here
                    </p>
              ...
              <h2 class="text-xl font-semibold text-center  text-purple-400">For Supporting Part 1 Elemental Teams</h2>
      ...
      <div class="flex justify-center gap-4 my-6">
        ...
        <div class="flex shadow-md relative space-x-4 p-2 rounded-sm items-center w-fit  bg-linear-to-r from-purple-500/75 to-cyan-500/0 overflow-hidden">
          ...
          <div class="absolute z-0 w-auto h-full top-0 left-0 opacity-50 mix-blend-overlay ">
            ...
            <div class="flex flex-col space-y-2 pr-2 z-10">
              <p class="text-sm sm:text-lg text-slate-100"> <b>Start:</b>  Starry Night + River Forest</p>
              <p class="text-sm sm:text-lg text-slate-100"> <b>Optional:</b> Cloud Valley.</p>
        ...
        <div class="mt-3 rounded-sm" >
          <p class="text-sm sm:text-base text-left">
              SI starts with two Ego signets. This is enough to clear a run. Cloud Valley helps gather enemies.</p>
          </div>
          ...
          <div class="mt-3 rounded-sm" >
              ...
              <p class="text-sm sm:text-base text-left">
              Starlit Astrologos helps gather enemies. If you get Cloud Valley signet, you can swap Starlit Astrologos for Snowy Sniper.
              </p>
          </div>
          <div class="divider  "></div>
        ...
        <ol class="list-decimal px-4 mb-6 text-sm sm:text-base">
          <li>Drop cross, then use Ultimate.</li>
          <li>Just spam Basic ATK, make sure you're stacking up red paint.</li>
          <li>When Ult buff duration is over (your 5 meter becomes 3 meter), use Ultimate. If you don't have enough sp for Ultimate, press Ult to attack while automatically switching colours. Combo ATK will give more sp regen.</li>
          <li>Repeat</li>
        </ol>
        ...
        <div class="relative overflow-hidden" style="padding-top: 56.25%;">
            <iframe
                class="absolute top-0 left-0 w-full h-full"
                src="https://www.youtube.com/embed/7B5JTs8sUJM"
                title="YouTube video player"
                frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen
        ...
        <h2 class="text-xl md:text-2xl font-semibold mb-0 md:mb-2 text-center sm:text-left">Special Equipment for Elysian Realm mode</h2> 

        <div class="flex flex-wrap gap-4 my-8">
          <!-- Example image list for support buffs; add your own image sources -->
          <img
            src="https://i.imgur.com/MyWOxqh.png"
            alt="ER Gears"
            class=" object-cover cursor-pointer"
            on:click={() => openLightbox('https://i.imgur.com/MyWOxqh.png')}
          />
    ...
    <div class=" gap-6 mt-5 mb-10">
      ...
      <div class="bg-gray-800 p-4 rounded-lg shadow-md">
        <h2 class="text-xl  font-semibold mb-2 text-left text-slate-100 cooltext">Starry Impression Support</h2>

        <p class="text-gray-200 mt-2 mb-4 text-sm sm:text-base">SI supporting CE DPS in Abyss</p>
  ...
  {/if}
      ...
      <div class="flex flex-col justify-center items-center">
        ...
        <p class="text-sm sm:text-base text-white">Cézanne T</p>
    ...
    <div class="text-center my-4 rounded-sm bg-gray-700">
      <p class="text-left text-sm sm:text-base px-2 py-3">
        <b>In-Game Text:</b><br/>
        Boosts Physical DMG dealt by Ultimate by 27% for a short duration after triggering any of the team's Ultimate. Can trigger once every 10s.
      </p>
    </div>

    <div class="text-center my-4 rounded-sm bg-cyan-700">
      <p class="text-left text-sm sm:text-base px-2 py-3 text-white">
        <b>Clarification + Correct Translation:</b><br/>
        When any team member Ultimate hits a target, for a short duration, Ultimate Physical DMG +27%, CD: 10 seconds, separate CD for every team member.
      </p>
    </div>
