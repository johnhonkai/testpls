...
<svelte:head>
    <title>Yae Kasumi - Darkbolt Jonin</title> 
    <meta property="og:title" content="Yae Kasumi - Darkbolt Jonin" />
    <meta property="og:description" content="Darkbolt Jonin Guide, Builds and Gameplay" />
    <meta property="og:image" content="https://i.imgur.com/uuctwZZ.png" />
    <meta property="og:url" content="https://marisaimpact.com/valk/dj" />
...
function selectTabMobile(event) {
  ...
  let fovlikes = likesData["dj"] || 0; // Get initial likes from JSON
  const charName = "dj"; // Route name for this character
...
<section class="relative mx-auto flex flex-row items-center justify-center px-4 md:p-2 gap-3 md:pb-0  md:mt-0  pt-4	sm:pt-0	">
  ...
  <div class="relative  w-auto h-48 sm:h-60 md:h-72 flex justify-center " id="valkpicbox">
    ...
    <img src="/images/valkfull/dj.png" alt="Sirin" class="h-full w-auto object-cover md:object-contain  " style ="view-transition-name: valkyrie-image-51;"/> 
  ...
  <div class="flex flex-col items-center text-center justify-start">
    ...
    <div >
    <h1 class="text-xl md:text-2xl text-slate-100 font-bold text-center leading-4 mb-4 sm:mb-1">Darkbolt Jonin</h1>
  </div>
    <!-- Character Name and Release Date -->
    <p class="text-base md:text-md text-center md:block hidden text-slate-300 my-2">Yae Kasumi | Release Date: v3.6 (26 Dec 2019)  </p>
  ...
  <div class="p-4 sm:p-4 bg-base-100 rounded-lg">
    ...
    <div>
        ...
        <ul class="list-disc ml-6 text-sm sm:text-base ">
          <li >Darkbolt Jonin (DJ) was a powerful Lightning DPS for her time.</li>
          <li >She is the first valkyrie utilizing the SP system.</li>
        ...
        <p class="mt-4 text-sm sm:text-base">
          ...
          <br/> After that, unlock other A-ranks that are available in Elysian Realm. Then you can consider getting DJ.
        ...
        <ul class="list-disc ml-6 text-sm sm:text-base ">
          <li ><strong>Darkbolt Jonin:</strong> Asterite Shop, Open World.</li>
...
{/if}
  ...
  {/if}
      ...
      <div class="divider  "></div>
                    ...
                    <h2 class="text-xl font-semibold text-center ">OPTIONAL</h2>
