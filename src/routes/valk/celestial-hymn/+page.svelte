...
<svelte:head>
    <title>Theresa - Celestial Hymn</title> 
    <meta property="og:title" content="Celestial Hymn" />
    <meta property="og:description" content="Celestial Hymn Guide, Builds and Gameplay" />
    <meta property="og:image" content="https://i.imgur.com/wd9SQV1.png" />
    <meta property="og:url" content="https://marisaimpact.com/valk/celestial-hymn" />
...
<CharacterLayout
  charName="Celestial Hymn"
  initialLikes={likesData["Celestial Hymn"] || 0}
  accent="bg-red-800"
  image="/images/valkfull/Celestial Hymn.png"
  alt="Celestial Hymn"

  titleEN="Celestial Hymn"
  titleCN="神恩颂歌"

  nameEN="Theresa Apocalypse"
  nameCN="德丽莎·阿波卡利斯"

  releaseEN="v2.2.3 (5 Sep 2018)"
  releaseCN="v1.8 (5 Oct 2017)"  

>
  <!-- Tags / Type Row -->
  <CharBio mode="dps" rank="s" type="bio" element="phy"  bg="bg-red-800"/>
  <CharBio mode="support" ar={['p1phy']} bg="bg-red-800" />
  ...
  <div class="p-4 sm:p-4 bg-base-100 rounded-lg">
    ...
    <div>
        ...
        <p class="mt-4 text-sm sm:text-base">
          <strong class="text-amber-400">Meta Physical Support</strong>
          <br/>
          
          
      </p>
        <ul class="list-disc ml-6 text-sm sm:text-base ">
          <li> Celestial Hymn (CH) carried the entire Physical meta on her back for 4+ years. </li>
          <li> CH received a PRI-ARM, which improved team's sp regen and Crit Rate.</li>
          <li> CH only got replaced when Herrscher of Sentience was released.</li>
        ...
        <p class="mt-4 text-sm sm:text-base">
          ...
          <br/>
You can farm CH in War Treasury. All valks in War Treasury are outdated, so you can unlock whoever you like first.
        ...
        <ul class="list-disc ml-6 text-sm sm:text-base ">
          <li ><strong>Celestial Hymn:</strong> War Treasury, Dorm Supply, Battle Pass.</li>
          <li ><strong>11th Sacred Relic:</strong> Exchange Shop, Battle Pass.</li>
  ...
  {/if}
      ...
      <div>
              ...
              <div class="flex flex-wrap my-2 rounded-lg overflow-hidden w-fit gap-1">
                ...
                <div class="w-20 h-20 sm:w-28 sm:h-28">
                  <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/07/72350798/469e9416d0f380be55056d368997734b_5409472448952333272.png" alt="Path to Acheron" class="w-full h-full object-cover">
              </div>


              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/24/72350798/73c6b8b29b02f16ed4d6535f3356e603_4967743279997622403.png" alt="Cecilia Youth T" class="w-full h-full object-cover">

              </div>


              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/10/29/72350798/b3a916851adaa466865e9d8800af757c_802132097853351376.png" alt="Cecilia Youth M" class="w-full h-full object-cover">

              </div>

              
              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/24/72350798/edc6733fda3b2cd58dc6bc7b4075af54_1692937805998245571.png" alt="Cecilia Youth B" class="w-full h-full object-cover">
            </div>

              </div>  
              <h4 class="text-base sm:text-base text-white"> 11th Leitourgia + Gluttony T, Mei Beach M, Newton B</h4>
              </div>

           <div class="divider"></div>
               <h2 class="text-xl font-semibold text-center  ">ANOTHER OPTION</h2>
              ...
              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/24/72350798/8df74cb6e5ee71bc13378e1da77cbedd_4073558693953229877.png" alt="Cecilia Youth T" class="w-full h-full object-cover">

              </div>


              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/24/72350798/f1f28faad25a7eb5ec89e85ff2366465_5111338525483495714.png" alt="Cecilia Youth M" class="w-full h-full object-cover">

              </div>

              
              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/24/72350798/edc6733fda3b2cd58dc6bc7b4075af54_418822854219925072.png" alt="Cecilia Youth B" class="w-full h-full object-cover">
            </div>

              </div>  
              <h4 class="text-base sm:text-base text-white"> Gustav TM Newton B</h4>
              </div>          
              
           <div class="divider"></div>
               <h2 class="text-xl font-semibold text-center  ">ORIGINAL STIGMA</h2>
              ...
              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/24/72350798/9e8be22e4e2c0e0122fc7aa0780850fb_3808614855239317337.png" alt="Cecilia Youth T" class="w-full h-full object-cover">

              </div>


              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/24/72350798/42a3fd539726402de9f494b33b8676ea_4773377749311527404.png" alt="Cecilia Youth M" class="w-full h-full object-cover">

              </div>

              
              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/24/72350798/d9cdd3c78e8105a469321b8a21b4e00f_5423022067209589300.png" alt="Cecilia Youth B" class="w-full h-full object-cover">
            </div>

              </div>  
              <h4 class="text-base sm:text-base text-white"> Kallen Hymn Set</h4>
              </div>     
      ...
      <div class=" gap-6 mt-5 mb-10">
        ...
        <div class="bg-gray-800 p-4 rounded-lg shadow-md">
          <h2 class="text-xl  font-semibold mb-4 text-left text-slate-100 cooltext">Abyss</h2>
          ...
          <div class="relative overflow-hidden" style="padding-top: 56.25%;">
            ...
            loading="lazy" 
                ...
                src="https://www.youtube.com/embed/8feqTXmzAek"
