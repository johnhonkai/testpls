...
<svelte:head>
    <title>Fu Hua - Night Squire</title> 
    <meta property="og:title" content="Fu Hua - Night Squire" />
    <meta property="og:description" content="Fu Hua - Night Squire Guide, Builds and Gameplay" />
    <meta property="og:image" content="https://i.imgur.com/0bnY0sB.png" />
    <meta property="og:url" content="https://marisaimpact.com/valk/night-squire" />
...
<CharacterLayout
  charName="ns"
  initialLikes={likesData["ns"] || 0}
  accent="bg-blue-800"
  image="/images/valkfull/Night Squire.png"
  alt="Night Squire"
  valk="false"

  titleEN="Night Squire"
  titleCN="白夜执事"

  nameEN="Fu Hua"
  nameCN="符华"

  releaseEN="v2.3 (7 Nov 2018)"
  releaseCN="v2.3 (10 May 2018)"  

>
  <!-- Tags / Type Row -->
  <CharBio mode="dps" rank="a" type="bio" element="phy"  bg="bg-blue-800"/>
  ...
  <div class="p-4 sm:p-4 bg-base-100 rounded-lg">
    ...
    <div>
        ...
        <p class="mt-4 text-sm sm:text-base">
          <strong class="text-amber-400">Combo Fighter DPS</strong>
          <br/>
          
          
      </p>
        <ul class="list-disc ml-6 text-sm sm:text-base ">
          <li> Night Squire (NS) was one of the strongest valks in her time. </li>
          <li> NS launches different combos depending on your punch and kick inputs. She also has multiple anicancels. These made NS one of the valks with the highest skill ceiling in the game. </li>
        ...
        <ul class="list-disc ml-6 text-sm sm:text-base ">
          <li ><strong>Night Squire:</strong> Open World, Expedition, Dorm Supply, Dorm Shop, Elysian Shop.</li>
          <li ><strong>Domain of Sentience:</strong> Exchange Shop, Battle Pass.</li>
      ...
      <div>
              ...
              <div class="flex flex-wrap my-2 rounded-lg overflow-hidden w-fit gap-1">
                ...
                <div class="w-20 h-20 sm:w-28 sm:h-28">
                  <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/17/75216984/50e3d0ebba92421b9b5953474c8b0f4c_8672443213675768495.png" alt="Path to Acheron" class="w-full h-full object-cover">
              </div>


              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/17/75216984/a7a0b9f6e047a0697911f3fc53d6ee35_3981169439103545986.png" alt="Cecilia Youth T" class="w-full h-full object-cover">

              </div>


              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/17/75216984/c85dd72ee95e8a4f67f107ae1cc4927a_5690732412438872965.png" alt="Cecilia Youth M" class="w-full h-full object-cover">

              </div>

              
              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/17/75216984/81d92e1c22df663252844ab02861dfe8_984969609845327754.png" alt="Cecilia Youth B" class="w-full h-full object-cover">
            </div>

              </div>  
              <h4 class="text-base sm:text-base text-white"> Domain of Sentience + G3 Dirac</h4>
              </div>
        ...
        <div class="bg-gray-800 p-4 rounded-lg shadow-md">
          ...
          <div class="relative overflow-hidden" style="padding-top: 56.25%;">
            ...
            loading="lazy" 
                ...
                src="https://www.youtube.com/embed/w_p-XchPIWY"
        ...
        <div class="bg-gray-800 p-4 rounded-lg shadow-md">
          ...
          <div class="relative overflow-hidden" style="padding-top: 56.25%;">
            ...
            loading="lazy" 
                ...
                class="absolute top-0 left-0 w-full h-full"
                src="https://www.youtube.com/embed/y7v_AivMlMc"
                title="YouTube video player"
                frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen>
