  ...
  <div class="p-4 sm:p-4 bg-base-100 rounded-lg">
    ...
    <div>
      ...
      <ul class="list-disc ml-6 text-sm sm:text-base mb-7">
        <li class="mt-2">Hawk of the Fog (HotF) was one of the best characters in the game with the highest skill ceiling. With the right boss attack and pro-level control, you can spam evade attack to deal big damage. There are also some attack chains that makes you get carpal tunnel.</li>
          <li class="mt-2">She was dominating both Abyss mode and Memorial Arena mode.</li>
