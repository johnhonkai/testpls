...
<section class="relative mx-auto flex flex-row items-center justify-center px-4 md:p-2 gap-3 md:pb-0  md:mt-0  pt-2	sm:pt-0	">
  ...
  <div class="flex flex-col items-center text-center justify-start">
    ...
    <p class="text-base md:text-md text-center md:block hidden text-slate-300 my-2">Kongming | Release Date: v4.0 (23 Jun 2020)  </p>
    ...
    <div class="w-full max-w-sm mb-2">
      ...
      <div class="flex flex-col items-center">
        <div class="flex w-[260px] md:w-[300px] gap-2 flex-wrap justify-center outline outline-teal-500 outline-1 bg-teal-950/75 rounded-lg p-2 backdrop-blur-xs">
    ...
    <div class="flex flex-col mt-4 items-center">
      ...
      <div class="flex flex-col  w-[260px] md:w-[300px] flex-wrap justify-center outline outline-teal-500 outline-1 bg-teal-950/75 rounded-lg p-2 backdrop-blur-xs">
