...
<svelte:head>
    <title>Kallen - Ritual Imayoh</title> 
    <meta property="og:title" content="Kallen - Ritual Imayoh" />
    <meta property="og:description" content="Kallen - Ritual Imayoh Guide, Builds and Gameplay" />
    <meta property="og:image" content="https://i.imgur.com/j2RQw32.png" />
    <meta property="og:url" content="https://marisaimpact.com/valk/ritual-imayoh" />
...
<CharacterLayout
  ...
  titleEN="Ritual Imayoh"
  titleCN="圣仪装·今样"

  nameEN="Kallen Kaslana"
  nameCN="卡莲·卡斯兰娜"

  releaseEN="v2.2.8 (18 Oct 2018)"
  releaseCN="v1.9 (23 Nov 2017)"  

>
  <!-- Tags / Type Row -->
  <CharBio mode="dps" rank="a" type="mech" element="phy"  bg="bg-blue-800"/>
  ...
  <div class="p-4 sm:p-4 bg-base-100 rounded-lg">
    ...
    <div>
        ...
        <p class="mt-4 text-sm sm:text-base">
          <strong class="text-amber-400">Physical DPS</strong>
          <br/>
          
          
      </p>
        <ul class="list-disc ml-6 text-sm sm:text-base ">
          <li> Ritual Imayoh (RI) was an average Physical DPS. She can fire homing missiles and summons turrets. </li>
          <li> RI was one of the first valks added to Elysian Realm. </li>
        ...
        <p class="mt-4 text-sm sm:text-base">
          ...
          Ritual Imayoh is available in Elysian Realm - she can give first-clear crystal reward.
        ...
        <ul class="list-disc ml-6 text-sm sm:text-base ">
          <li ><strong>Ritual Imayoh:</strong> Open World, Expedition, Dorm Supply, Dorm Shop, Elysian Shop.</li>
      ...
      <div>
              ...
              <div class="flex flex-wrap my-2 rounded-lg overflow-hidden w-fit gap-1">
                ...
                <div class="w-20 h-20 sm:w-28 sm:h-28">
                  <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/10/29/77124895/636c22c8b875273b04dfa95aaa4be174_8217611637458837009.png" alt="Path to Acheron" class="w-full h-full object-cover">
              </div>
              ...
              <h4 class="text-base sm:text-base text-white"> Domain of the Void + Bianka Theater</h4>
              </div>
        ...
        <div class="bg-gray-800 p-4 rounded-lg shadow-md">
          ...
          <div class="relative overflow-hidden" style="padding-top: 56.25%;">
            ...
            loading="lazy" 
                ...
                src="https://www.youtube.com/embed/7yHfFwpvEDU"
