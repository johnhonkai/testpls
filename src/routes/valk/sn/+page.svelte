...
<svelte:head>
    <title>Seele - Stygian Nymph</title> 
    <meta property="og:title" content="Seele - Stygian Nymph" />
    <meta property="og:description" content="Stygian Nymph Guide, Builds and Gameplay" />
    <meta property="og:image" content="https://i.imgur.com/5X1uhDj.png" />
    <meta property="og:url" content="https://marisaimpact.com/valk/sn" />
...
function selectTabMobile(event) {
  ...
  let fovlikes = likesData["sn"] || 0; // Get initial likes from JSON
  const charName = "sn"; // Route name for this character
...
<section class="relative mx-auto flex flex-row items-center justify-center px-4 md:p-2 gap-3 md:pb-0  md:mt-0  pt-4	sm:pt-0	">
  ...
  <div class="relative  w-auto h-48 sm:h-60 md:h-72 flex justify-center " id="valkpicbox">
    ...
    <img src="/images/valkfull/sn.png" alt="Sirin" class="h-full w-auto object-cover md:object-contain  " style ="view-transition-name: valkyrie-image-51;"/> 
  ...
  <div class="flex flex-col items-center text-center justify-start">
    ...
    <div >
    <h1 class="text-xl md:text-2xl text-slate-100 font-bold text-center leading-4 mb-4 sm:mb-1">Stygian Nymph</h1>
  </div>
    <!-- Character Name and Release Date -->
    <p class="text-base md:text-md text-center md:block hidden text-slate-300 my-2">Seele Vollerei | Release Date: v3.5 (14 Nov 2019)  </p>
    ...
    <div class="w-full max-w-sm mb-2">
      ...
      <div class="flex flex-col items-center">
        <div class="flex w-[260px] md:w-[300px] gap-2 flex-wrap justify-center outline outline-red-500 outline-1 bg-red-950/75 rounded-lg p-2 backdrop-blur-xs">
          ...
          <img src="/images/type/IconQUA.png" alt="BIO" class="w-auto h-8 md:h-10" />
  ...
  <div class="p-4 sm:p-4 bg-base-100 rounded-lg">
    ...
    <div>
      ...
      <ul class="list-disc ml-6 text-sm sm:text-base">
          <li class="mt-2"> Stygian Nymph (SN) was a powerful Quantum Physical DPS. She was mandatory for Memorial Arena almost every week during her prime.</li>
          <li class="mt-2"> She was briefly revived with PRI-ARM weapon.</li>
      ...
      <ul class="list-disc ml-6 text-sm sm:text-base">
        <li class="mt-2">Sirin and Herrscher of Sentience are the only battlesuits in War Treasury that are still somewhat relevant, so no, not recommended to farm Stygian Nymph first. </li>
          <li class="mt-2"> You can consider unlocking Stygian Nymph in the future for Elysian Realm first-clear crystal rewards.</li>
        ...
        <ul class="list-disc ml-6 text-sm sm:text-base ">
          <li ><strong>Stygian Nymph:</strong> Dorm Supply, War Treasury, Battle Pass.</li>
          <li ><strong>Path to Acheron:</strong> Exchange Shop, Battle Pass.</li>
          <li ><strong>Allan Poe:</strong> Exchange Shop, Battle Pass.</li>
      ...
      <div>
              ...
              <div class="flex flex-wrap my-2 rounded-lg overflow-hidden w-fit gap-1">
                ...
                <div class="w-20 h-20 sm:w-28 sm:h-28">
                  <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/07/81417673/26139bb7b64940272e694292602254d6_761514438154261451.png" alt="Vita" class="w-full h-full object-cover">
              </div>


              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/23/81417673/07af6da5cccbed3086f815cfb69cdcdb_6543676701408068242.png" alt="Cecilia Youth T" class="w-full h-full object-cover">

              </div>


              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/23/81417673/9e99b98bc5f6ace0254fd87e59cb084e_1841921685920848696.png" alt="Cecilia Youth M" class="w-full h-full object-cover">

              </div>

              
              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/23/81417673/881a3e55c864ea2e5b54831882efc41b_6933173020663814554.png" alt="Cecilia Youth B" class="w-full h-full object-cover">
            </div>

              </div>  
              <h4 class="text-base sm:text-base text-white"> Path to Acheron + Allan Poe set </h4>
              </div>
      ...
      <div class="divider  "></div>
        ...
        <div class="flex shadow-md relative space-x-4 p-2 rounded-sm items-center w-fit  bg-linear-to-r from-purple-500/75 to-cyan-500/0 overflow-hidden">
          ...
          <div class="absolute z-0 w-auto h-full top-0 left-0 opacity-50 mix-blend-overlay ">
            ...
            <div class="flex flex-col space-y-2 pr-2 z-10">
              <p class="text-sm sm:text-lg text-slate-100"> <b>Start:</b> Vulnerable Duality + Intergrowth</p>
              <p class="text-sm sm:text-lg text-slate-100"> <b>Optional:</b> Union</p>
          ...
          <ol class="list-decimal px-4 mb-6 text-sm sm:text-base">
            <li>Use Ultimate </li>
            <li>Evade ➔ Use Charged ATK. Do this one more time. </li>
            <li>Repeat.</li>
        ...
        <div class="relative overflow-hidden" style="padding-top: 56.25%;">
            <iframe
                ...
                src="https://www.youtube.com/embed/PnguQ0EGu0k"
