...
<svelte:head>
  <title>Raven - Midnight Absinthe</title> 

    <meta property="og:title" content="Raven - Midnight Absinthe"/>
    <meta property="og:description" content="Midnight Absinthe Guide, Builds and Gameplay" />
    <meta property="og:image" content="" />
    <meta property="og:url" content="https://marisaimpact.com/valk/raven" />
...
function selectTabMobile(event) {
  ...
  let celikes = likesData["raven"] || 0; // Get initial likes from JSON
  const charName = "raven"; // Route name for this character
...
<div class="relative  w-auto h-48 sm:h-60 md:h-72 flex justify-center " id="valkpicbox">
  ...
  <img src="/images/valkfull/raven.webp" alt="Sparkle" class="h-full w-auto object-cover md:object-contain  " style ="view-transition-name: valkyrie-image-36;"/> 
...
<div class="flex flex-col items-center text-center justify-start">
  ...
  <div>
  <h1 class="text-xl md:text-2xl text-slate-100 font-bold text-center leading-4 mb-4 sm:mb-0">Midnight Absinthe</h1>
</div>
  <!-- Character Name and Release Date -->
  <p class="text-base md:text-md custom-font mb-2 text-center tracking-wider sm:block hidden text-slate-100">Raven | Release Date: v5.2 (21 Oct 2021) 
...
<section class="max-w-[960px] mx-auto flex flex-col gap-1 sm:p-1 mb-6 ">
  ...
  <div class="p-4 sm:p-4 bg-base-100 rounded-lg">
      ...
      <div>
          ...
          <p class="text-sm sm:text-base mt-4">
              <b class="text-amber-400">Outdated P1 Fire Support</b><br/> 
              Raven is an outdated Part 1 Fire support. Currently, she has been replaced by <a href="/valk/sparkle" class="link ">Sparkle</a> and  <a href="/valk/cn" class="link ">Chrono Navi.</a>
          </p>

          <p class="text-sm sm:text-base mt-4">
            <b class="text-amber-400">Back in Her Prime...</b><br/> 
            - Raven was very slow and sluggish.
            <br/> 
            - As a bow user, Raven was used to counter MHT-3B weak spot.
            <br/>
            - As the first IMG valk, Raven was a necessary counter for HoD Minion.
        </p>
          ...
          <p class="mt-4 text-sm sm:text-base">
              <b class="text-amber-400">New Players on Midnight Absinthe</b>
              <br/>Farm <a href="/valk/coralie" class="link ">Coralie Valkyrie Blastmetal</a>               first from Asterite Shop and Open World since she can fit in any Astral Ring team. If you have extra Asterite, then you can consider getting Raven for Elysian Ream first-clear crystal rewards.
            </p>


          <p class="mt-4 text-sm sm:text-base mb-2">
            <b class="text-amber-400">New Players on Raven weapon Obscuring Wing</b><br/> 
            Only use your crystal to pull Part 2 valkyries, since they use a new Astral Ring system. If Obscuring Wing is available through other means, such as spending event or Battle Pass, you can consider getting it that way.
        </p>

          <p class="mt-4 text-sm sm:text-base">
              <b class="text-amber-400">Competitive</b><br/> No use.
          </p>
          ...
          <ul class="list-disc ml-6 text-sm sm:text-base ">
              <li ><strong>Midnight Absinthe:</strong> Asterite Shop, Open World Task</li>
              <li><strong>G4 Aslaug:</strong> Foundry </li>
              <li><strong>Obscuring Wing:</strong> Focused Supply </li>
          ...
          <div class="relative overflow-hidden" style="padding-top: 56.25%;">
            <iframe
                ...
                src="https://www.youtube.com/embed/hwnyh3La7Ik"
  ...
  {/if}
      ...
      <div>
              ...
              <div class="flex flex-wrap my-2 rounded-lg overflow-hidden w-fit gap-1">
                <div class="w-20 h-20 sm:w-28 sm:h-28">
                  <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/10/30/6100274/c6197d599ae57031e1bd20641328815a_1515539067326209072.png?x-oss-process=image/quality,q_75/resize,s_120" alt="Vita" class="w-full h-full object-cover">
                </div>
                <div class="w-20 h-20 sm:w-28 sm:h-28">
                  <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/10/27/77124895/6f5dcc3c2e0f150b3073b2dfd11e57cb_754015294218655642.png?x-oss-process=image/quality,q_75/resize,s_120" alt="Vita" class="w-full h-full object-cover">

                </div>

                <div class="w-20 h-20 sm:w-28 sm:h-28">
                  <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/10/27/77124895/73f67f4d3998dfe3394682ac2a733ac6_8239283043787949047.png?x-oss-process=image/quality,q_75/resize,s_120" alt="Vita" class="w-full h-full object-cover">

                </div>

                <div class="w-20 h-20 sm:w-28 sm:h-28">
                  <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/10/27/77124895/b41da8a58955e28a650f26107e6d5f9f_5650994552200949882.png?x-oss-process=image/quality,q_75/resize,s_120" alt="Vita" class="w-full h-full object-cover">

                </div>
              </div>  
              <h4 class="text-base sm:text-base text-white">Midnight Absinthe + Aslaug Set</h4>
              </div>

              <div class="divider divider-neutral"></div>
              <h2 class="text-xl font-semibold text-center  text-blue-400">SITUATIONAL</h2>
      ...
      <h2 class="text-xl md:text-2xl font-semibold mt-8 mb-0 md:mb-2 text-center sm:text-left text-blue-400">Warning: Weak Valk</h2> 
      <p class="text-sm sm:text-base text-center sm:text-left">
        This is a very old valkyrie with very weak ER signets. Please play at a lower difficulty.
      </p>
      ...
      <div class="divider divider-neutral"></div>
        ...
        <div class="flex shadow-md relative space-x-4 p-2 rounded items-center w-fit  bg-gradient-to-r from-purple-500/75 to-cyan-500/0 overflow-hidden">
          ...
          <div class="absolute z-0 w-auto h-full top-0 left-0 opacity-50 mix-blend-overlay ">
            ...
            <div class="flex flex-col space-y-2 pr-2 z-10">
              <p class="text-sm sm:text-lg text-slate-100"> <b>Start:</b> Wild Hunt + Suppression</p>
              <p class="text-sm sm:text-lg text-slate-100"> <b>Optional:</b> Raven Plume </p>
        ...
        <div class="mt-3 rounded" >
          <p class="text-sm sm:text-base text-left">
            ...
            <li class="text-sm sm:text-base"> Normal mode: Wild Hunt enables the rotation, Suppression provides damage. You can get both Ego signets at the start by using Thorny Crown sigil, OR by resetting Floor 1 until you get another Ego portal, OR use Because of You support sigil and get the other two Ego signets on Floor 7.</li>
        </p>
          </div>
        ...
        <ol class="list-decimal px-4 mb-6 text-sm sm:text-base">
          <li>Evade forward, get close to the enemy.</li>
          <li>Long press ATK, then press ATK three times to fire arrow.</li>
          <li>Repeat step 2.</li>
          <li>You can use weapon skill to trigger signet buffs like Helix. Other than that, weapon skill doesn't grant any buff for Raven herself.</li>

        </ol>
        <p class="text-sm sm:text-base text-left">
          <b>Technical Info</b>
          <br/> - Evade enemy's attacks. Raven is easily staggered.
          <br/> - Stay close to the enemy. Otherwise, your attacks can miss.
        ...
        <div class="relative overflow-hidden" style="padding-top: 56.25%;">
            <iframe
                class="absolute top-0 left-0 w-full h-full"
                src="https://www.youtube.com/embed/a5XuQup1P2U"
                title="YouTube video player"
                frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen
