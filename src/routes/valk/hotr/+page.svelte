...
<div class="relative  w-auto h-48 sm:h-60 md:h-72 flex justify-center ">
  ...
  <img src="/images/valkfull/bronya_hotr.png" alt="Sparkle" class="h-full w-auto object-cover md:object-contain  " style ="view-transition-name: valkyrie-image-1;"/> 
...
<div class="flex flex-col items-center text-center justify-start">
  ...
  <div>
  <h1 class="text-xl md:text-2xl text-slate-100 font-bold text-center leading-4 mb-2 sm:mb-0">Herrscher of Truth</h1>
</div>
