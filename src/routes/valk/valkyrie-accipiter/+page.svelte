...
<svelte:head>
    <title>Fu Hua - Valkyrie Accipiter</title> 
    <meta property="og:title" content="Fu Hua - Valkyrie Accipiter" />
    <meta property="og:description" content="Fu Hua - Valkyrie Accipiter Guide, Builds and Gameplay" />
    <meta property="og:image" content="https://i.imgur.com/47Q3NFP.png" />
    <meta property="og:url" content="https://marisaimpact.com/valk/valkyrie-accipiter" />
...
<CharacterLayout
  charName="Valkyrie Accipiter"
  initialLikes={likesData["Valkyrie Accipiter"] || 0}
  accent="bg-blue-800"
  image="/images/valkfull/Valkyrie Accipiter.png"
  alt="NValkyrie Accipiter"
  valk="false"

  titleEN="Valkyrie Accipiter"
  titleCN="女武神·迅羽"
  ...
  releaseCN="v2.0 (11 Jan 2018)"  

>
  <!-- Tags / Type Row -->
  <CharBio mode="dps" rank="a" type="psy" element="phy"  bg="bg-blue-800"/>
  ...
  <div class="p-4 sm:p-4 bg-base-100 rounded-lg">
    ...
    <div>
        ...
        <p class="mt-4 text-sm sm:text-base">
          <strong class="text-amber-400">Beta Night Squire DPS</strong>
          <br/>
          
          
      </p>
        <ul class="list-disc ml-6 text-sm sm:text-base ">
          <li> Valkyrie Accipiter (VA) was garbage. However, her augment form <a href="/valk/hotf" class="link">Hawk of the Fog</a> was one of the best valks in the game. </li>
          <li> VA can throw fireball, and has high shield break attack (for her time). </li>
      ...
      <div>
              ...
              <div class="flex flex-wrap my-2 rounded-lg overflow-hidden w-fit gap-1">
                ...
                <div class="w-20 h-20 sm:w-28 sm:h-28">
                  <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/07/91006211/50e3d0ebba92421b9b5953474c8b0f4c_7098070467438305494.png" alt="Path to Acheron" class="w-full h-full object-cover">
              </div>
              ...
              <h4 class="text-base sm:text-base text-white"> Domain of Sentience + Bianka Theater</h4>
              </div>
