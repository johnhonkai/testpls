...
<svelte:head>
    <title>Twilight Paladin</title> 
    <meta property="og:title" content="Twilight Paladin" />
    <meta property="og:description" content="Twilight Paladin Guide, Builds and Gameplay" />
    <meta property="og:image" content="" />
    <meta property="og:url" content="https://marisaimpact.com/valk/tp" />
...
function selectTabMobile(event) {
  ...
  let fovlikes = likesData["tp"] || 0; // Get initial likes from JSON
  const charName = "tp"; // Route name for this character
...
<section class="relative mx-auto flex flex-row items-center justify-center px-4 md:p-2 gap-3 md:pb-0  md:mt-0  pt-2	sm:pt-0	">
  ...
  <div class="relative  w-auto h-48 sm:h-60 md:h-72 flex justify-center " id="valkpicbox">
    ...
    <img src="/images/valkfull/tp.png" alt="Sirin" class="h-full w-auto object-cover md:object-contain  " style ="view-transition-name: valkyrie-image-45;"/> 
  ...
  <div class="flex flex-col items-center text-center justify-start">
    ...
    <div class="mt-4">
    <h1 class="text-xl md:text-2xl text-slate-100 font-bold text-center leading-4 mb-4 sm:mb-0">Twilight Paladin</h1>
  </div>
    <!-- Character Name and Release Date -->
    <p class="text-base md:text-md text-center md:block hidden text-slate-300 my-2">Theresa | Release Date: v3.4 (26 Sep 2019)  </p>
      ...
      <div class="flex flex-col mt-4 items-center">
        ...
        <div class="flex flex-col  w-[260px] md:w-[300px] flex-wrap justify-center outline outline-pink-500 outline-1 bg-pink-950/75 rounded-lg p-2 backdrop-blur-xs">
          <div class="flex flex-wrap justify-center">
            <h2 class="text-sm md:text-base mb-2 text-slate-100">Augment form of Violet Executor</h2>
          </div >
          <div class="flex flex-row gap-2 flex-wrap justify-center">
            <img src="/images/valkportrait/Theresa Violet Executor.png" alt="VE" class="w-auto h-14 md:h-20" />
  ...
  <div class="p-4 sm:p-4 bg-base-100 rounded-lg">
    ...
    <div>
      ...
      <ul class="list-disc ml-6 text-sm sm:text-base mb-7">
        <li class="mt-2">Twilight Paladin (TP) was a powerful Physical DPS that can unlesh a devastating slash when you reach 200+ hitcount.</li>
          <li class="mt-2">She was revived into meta for some time with her PRI-ARM.</li>
          <li class="mt-2">Can apply minor Bleed trauma.</li>
      ...
      <p class="mt-4 text-sm sm:text-base">
        <strong class="text-amber-400 ">New Players on TP augment materials</strong>
        ...
        After that, unlock other A-ranks that are available in Elysian Realm for the first-clear crystal rewards. Then you can consider getting TP augment materials.
      </p>

      <p class="mt-6 text-sm sm:text-base">
        <strong class="text-amber-400 ">Violet Executor in War Treasury Shop</strong>
      </p>
      <ul class="list-disc ml-6 text-sm sm:text-base">
        <li class="mt-2">Sirin and Herrscher of Sentience are the only battlesuits in War Treasury that are still somewhat relevant, so no, not recommended to farm Violet Executor first. </li>
          <li class="mt-2"> You can consider unlocking Violet Executor in the future for Elysian Realm first-clear crystal rewards.</li>
        ...
        <ul class="list-disc ml-6 text-sm sm:text-base ">
            <li ><strong>Twilight Paladin Augment Materials:</strong> Open World, Asterite Shop.</li>
            <li ><strong>Violet Executor:</strong> Dorm Supply, War Treasury, Battle Pass.</li>
            <li ><strong>Hekate:</strong> Exchange Shop, Battle Pass.</li>
            <li ><strong>G3 Kafka:</strong> Exchange Shop, Foundry, Battle Pass.</li>
      ...
      <div>
              ...
              <div class="flex flex-wrap my-2 rounded-lg overflow-hidden w-fit gap-1">
                ...
                <div class="w-20 h-20 sm:w-28 sm:h-28">
                  <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/11/17/77124895/519f8ed24e9042f1b487728032a44e8a_1695765566065333765.png" alt="Hekate" class="w-full h-full object-cover">
              </div>

              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/27/73514954/cb701147b58fa90ce2d1c697a71db069_5506811451066306725.png" alt="Kafka T" class="w-full h-full object-cover">

              </div>


              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/27/73514954/421f0e3c83f15f60a082c06a829fd993_950638549263740853.png" alt="Kafka M" class="w-full h-full object-cover">

              </div>

              
              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/27/73514954/bb2cfcd7fcf39c6895b3e7df38d9e248_4158521663555358344.png" alt="Kafka B" class="w-full h-full object-cover">
            </div>
          


              </div>  
              <h4 class="text-base sm:text-base text-white"> Hekate's Sombre + G3 Kafka set</h4>
              </div>
