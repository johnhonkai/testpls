...
<style>
  #star-container {
    background: radial-gradient(rgb(var(--light-red-darker-rgb)), rgb(var(--dark-red-darker-rgb)));
  }

  #star-gradient-overlay {
    background: radial-gradient(circle, transparent 75%, rgb(var(--dark-red-darker-rgb)));
  }
