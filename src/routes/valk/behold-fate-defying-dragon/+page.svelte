...
<section class="max-w-[960px] mx-auto flex flex-col gap-1 sm:p-1 mb-6 ">
  ...
  <div class="p-4 sm:p-4 bg-base-100 rounded-lg">
      ...
      <div>
          ...
          <ul class="list-disc ml-6 text-sm sm:text-base">
                <li>Breach State: BFD provides Phy / Ele Breach, a powerful buff, basically DEF PEN from Star Rail. Certain skills are also activated when valks have Breach state.</li>
                <li>Trauma Boost: Rampant Dragon Claws adds 12 (S) / 36 (SS2) points to any status trauma inflicted by the leader. BFD also extends status trauma duration by 50%.  </li> 
                <li>Ignite trauma.  </li> 
          ...
          <ul class="list-disc ml-6 text-sm sm:text-base">
            ...
            <p class="mt-4 text-sm sm:text-base">
              ...
              <br/>
              BFD is the new best support for Vita Lone Planetfarer team. BFD doesn't exactly replace Valkyrie Blastmetal (VBM). Rather, Vita's best team now is Vita + BFD + either HoFi / VBM. I'm not even kidding, A-rank Coralie lives.   
...
Start saving from now. Or whale up bro.
          ...
          <p class="mt-2 text-sm sm:text-base pb-4">
            ...
            <iframe
                ...
                src="https://www.youtube.com/embed/jd-ohD_6dOE"
      ...
      <div class=" gap-6 mt-4">
        ...
        <div class="bg-gray-800 p-4 rounded-lg shadow-md ">
          ...
          <div class="relative overflow-hidden" style="padding-top: 56.25%;">
            <iframe
                class="absolute top-0 left-0 w-full h-full"
                src="https://www.youtube.com/embed/aqBxBthIj1I"
                title="YouTube video player"
                frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen
