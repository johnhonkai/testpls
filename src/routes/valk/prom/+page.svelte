...
<div class="flex flex-col items-center text-center justify-start">
  ...
  <div class="w-full max-w-sm mb-2">
    ...
    <div class="flex flex-col items-center">
      <div class="flex w-[260px] md:w-[300px] gap-2 flex-wrap justify-center outline outline-slate-500 outline-1 bg-slate-950/75 rounded-lg p-2 backdrop-blur-sm">
    ...
    <div class="flex flex-col mt-4 items-center">
      ...
      <div class="flex flex-col  w-[260px] md:w-[300px] flex-wrap justify-center outline outline-slate-500 outline-1 bg-slate-950/75 rounded-lg p-2 backdrop-blur-sm">
