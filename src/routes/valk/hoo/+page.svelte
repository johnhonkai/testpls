...
function selectTabMobile(event) {
  ...
  onMount(async () => {
    ...
    hoolikes = await (await import("$lib/firebaseLikes")).getLikesFromFirestore(charName); // Fetch current likes
  });
  ...
  async function increaseLike() {
    ...
    hoolikes = await likeWithVoterId(charName, voterId); // Like with voter ID tracking
