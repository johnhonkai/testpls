...
function selectTabMobile(event) {
  ...
  let hoolikes = likesData["hoo"] || 0; // Get initial likes from JSON
  const charName = "hoo"; // Route name for this character
...
<div class="relative  w-auto h-48 sm:h-60 md:h-72 flex justify-center " id="valkpicbox">
  ...
  <div class="absolute bottom-0 left-0 like-container flex items-center gap-2 mt-4">
    <button
      ...
      <span class="text-white font-semibold">{hoolikes}</span>
    </button>
  </div>
          ...
          <table class="table table-zebra w-full bg-gray-800 rounded-lg shadow-md text-base">
            ...
            <tbody>
              ...
              <tr>
                <td >S1</td>
                <td>
                  After QTE Or Basic ATK SEQ 4 hits, enemies take 17% ➔ 20% more Lightning DMG from HoO (independent multiplier)
                </td>
                <td class="p-3">DPS</td>
              </tr>
              <!-- Sample Row 2 -->
              <tr>
                ...
                <td>
                  ...
                  2. Enemies take 29% ➔ 33% more Lightning DMG from HoO
                </td>
              ...
              <tr>
                <td>S3</td>
                <td>
                  Leader Skill: Team Elemental DMG +24% ➔ 27%. Initial sp +35 ➔ 40. When Kiana is on the team, the Kiana valk and HoO gain additional initial sp +35 ➔ 40.
              ...
              <tr>
                <td>SS1</td>
                <td>
                  Lightning DMG +35% ➔ 40%. Combo and Ult gain Lightning DMG +50% ➔ 60%	
                                </td>
                <td>DPS
              </tr>
              <tr>
                <td>SS2</td>
                <td>
                  On hit, Malice Expunged restore 4 ➔ 5 sp for HoO, HoO gain Total DMG +30% ➔ 35%, and take 25% ➔ 30% less Total DMG.                </td>
                <td>DPS
              </tr>
              <tr>
                <td>SS3</td>
                <td>
                  Leader Skill: Team Elemental DMG +27% ➔ 30%. Initial sp +40 ➔ 45. When Kiana is on the team, the Kiana valk and HoO gain additional initial sp +40 ➔ 45.                
                </td>
                <td>DPS<br/>Support<br/>Arena</td>
