...
<svelte:head>
    <title>Bronya - Black Nucleus</title> 
    <meta property="og:title" content="Bronya Black Nucleus" />
    <meta property="og:description" content="Bronya Black Nucleus Guide, Builds and Gameplay" />
    <meta property="og:image" content="https://i.imgur.com/j93bALg.png" />
    <meta property="og:url" content="https://marisaimpact.com/valk/black-nucleus" />
...
<CharacterLayout
  charName="Black Nucleus"
  initialLikes={likesData["Black Nucleus"] || 0}
  accent="bg-red-800"
  image="/images/valkfull/Black Nucleus.png"
  alt="Black Nucleus"
  valk="false"

  titleEN="Black Nucleus"
  titleCN="异度黑核侵蚀"

  nameEN="Bronya Zaychik"
  nameCN="布洛妮娅·扎伊切克"

  releaseEN="v2.2.2 (8 Aug 2018)"
  releaseCN="v1.7 (24 Aug 2017)"  
  ...
  <div class="p-4 sm:p-4 bg-base-100 rounded-lg">
    ...
    <div>
        ...
        <p class="mt-4 text-sm sm:text-base">
          <strong class="text-amber-400">Physical Nuker</strong>
          <br/>
          
          
      </p>
        <ul class="list-disc ml-6 text-sm sm:text-base ">
          <li> Black Nucleus (BN) was a DPS that unleashes short bursts of high damage.</li>
          <li> BN was the only valk that can get 0 second clear in Arena in her time. Only pro whales could achieve this.</li>
          <li> She received a PRI-ARM update, but it was more of a fun upgrade than useful.</li>
        ...
        <p class="mt-4 text-sm sm:text-base">
          ...
          <br/>
You can farm BN in War Treasury. All valks in War Treasury are outdated, so you can unlock whoever you like first.
        ...
        <ul class="list-disc ml-6 text-sm sm:text-base ">
          <li ><strong>Star Destroyer 19C-X:</strong> War Treasury, Dorm Supply, Battle Pass.</li>
...
{/if}
  ...
  {/if}
      ...
      <div>
              ...
              <h2 class="text-xl font-semibold text-center  text-yellow-400">NUKE BUILD</h2>
              ...
              <div class="flex flex-wrap my-2 rounded-lg overflow-hidden w-fit gap-1">
                ...
                <div class="w-20 h-20 sm:w-28 sm:h-28">
                  <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/23/50494840/5866d947324ff245f78fa34d9d62bf3a_7397642915875404867.png" alt="Path to Acheron" class="w-full h-full object-cover">
              </div>


              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/23/50494840/d8388ab693360349260a52dcb92d24e1_2728144682763893226.png" alt="Cecilia Youth T" class="w-full h-full object-cover">

              </div>


              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/23/50494840/2ab45d3dabd2355751d199c562fd982b_6294010689124777624.png" alt="Cecilia Youth M" class="w-full h-full object-cover">

              </div>

              
              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/23/50494840/107dc15190c1d5627299f09d43c3245c_5375886397556130095.png" alt="Cecilia Youth B" class="w-full h-full object-cover">
            </div>

              </div>  
              <h4 class="text-base sm:text-base text-white"> Star Destroyer 19C-X + Schrodinger T Planck M Sin Mal B</h4>
              </div>
