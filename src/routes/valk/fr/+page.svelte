...
function selectTabMobile(event) {
  ...
  let fovlikes = likesData["fr"] || 0; // Get initial likes from JSON
  const charName = "fr"; // Route name for this character
...
<section class="relative mx-auto flex flex-row items-center justify-center px-4 md:p-2 gap-3 md:pb-0  md:mt-0  pt-2	sm:pt-0	">
  ...
  <div class="relative  w-auto h-48 sm:h-60 md:h-72 flex justify-center " id="valkpicbox">
    ...
    <img src="/images/valkfull/fr.webp" alt="Sirin" class="h-full w-auto object-cover md:object-contain  " style ="view-transition-name: valkyrie-image-46;"/> 
  ...
  <div class="flex flex-col items-center text-center justify-start">
    ...
    <div>
    <h1 class="text-xl md:text-2xl text-slate-100 font-bold text-center leading-4 mb-4 sm:mb-0">Fallen Rosemary</h1>
  </div>
    <!-- Character Name and Release Date -->
    <p class="text-base md:text-md text-center md:block hidden text-slate-300 my-2">Rita "Irene Adler" | Release Date: v4.2 (15 Sep 2020)  </p>
    ...
    <div class="w-full max-w-sm mb-2">
      ...
      <div class="flex flex-col items-center">
        <div class="flex w-[260px] md:w-[300px] gap-2 flex-wrap justify-center outline outline-violet-500 outline-1 bg-violet-950/75 rounded-lg p-2 backdrop-blur-xs">
    ...
    <div class="flex flex-col mt-4 items-center">
      ...
      <div class="flex flex-col  w-[260px] md:w-[300px] flex-wrap justify-center outline outline-violet-500 outline-1 bg-violet-950/75 rounded-lg p-2 backdrop-blur-xs">
  ...
  <div class="p-4 sm:p-4 bg-base-100 rounded-lg">
    ...
    <div>
        ...
        <p class="mt-4 text-sm sm:text-base">
          ...
          <br/>
          - Fallen Rosemary (FR) was a great Lightning support, but heavily required her signature weapon and ranks to be 'usable'.
          <br/>
          - Her gameplay feels somewhat sluggish when holding buttons to chain actions together.
      </p>

      <p class="mt-4 text-sm sm:text-base">
        <strong class="text-amber-400">Quantum Collapse Support</strong>
        <br/>
        Some of her buffs affect Fire and Ice valks too, so FR can be used by other teams that require quantum collapse.
    </p>
        ...
        <p class="mt-4 text-sm sm:text-base">
          <strong class="text-amber-400 ">New Players on FR</strong>
      </p>

      <ul class="list-disc ml-6 text-sm sm:text-base">
        <li class="mt-2">Not sure if FR is still part of the starter event. Will update in the future.</li>

        <li class="mt-2">Sirin, Sushang and Herrscher of Sentience are the only battlesuits in War Treasury that are still somewhat relevant, so no, not recommended to farm FR first. </li>
          <li class="mt-2"> You can consider unlocking FR in the future for Elysian Realm first-clear crystal rewards.</li>

      </ul>

      <p class="mt-4 text-sm sm:text-base">
        <strong class="text-amber-400 ">New Players on FR Equipment</strong>
        <br/>
    </p>

    <ul class="list-disc ml-6 text-sm sm:text-base">

        <li class="mt-2"> Stigma: FR can use a variety of stigma (Turgenev, Handel, etc), all are available in foundry.</li>
        <li class="mt-2"> Her signature weapon Iris of the Dream is available in starter event (Not sure if it's still there, will update in the future).
        </li>
...
{/if}
      ...
      <div>
              ...
              <div class="flex flex-wrap my-2 rounded-lg overflow-hidden w-fit gap-1">
                ...
                <div class="w-20 h-20 sm:w-28 sm:h-28">
                  <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/07/72350798/432bea468bc1c0069a07e623ccf86353_6014437111279916630.png?x-oss-process=image/quality,q_75/resize,s_120" alt="Vita" class="w-full h-full object-cover">
              </div>



              </div>  
              <h4 class="text-base sm:text-base text-white"> Iris of Helheim </h4>
              </div>
           ...
           <div>
            ...
            <div class="p-4 mt-4 bg-linear-to-r from-violet-950/75 to-violet-900/75 rounded-sm">
              <p class="text-sm sm:text-base text-left">
                <b>Iris Helheim </b><br/> - A must-have for Fallen Rosemary. 
                <br/> - Has an important utility: Weapon skill activates Valfreyja form immediately, and fully restore Disir meter.
                <br/> - Adds timestop to Ultimate.
              </p>
            ...
            <h2 class="text-lg sm:text-xl font-semibold text-center  text-sky-400"> SUPPORT STIGMA OPTIONS </h2>
            ...
            <div class="p-4 mt-4 bg-linear-to-r from-zinc-950/75 to-zinc-900/75 rounded-sm">
              <p class="text-sm sm:text-base text-left mb-4">
                <b>G3 Turgenev</b><br/> - Better for pure support option, less self damage.<br/>- Forgeable in Foundry.
              </p>

            
              <p class="text-sm sm:text-base text-left">
                <b>Affix</b><br/> SP recovery, SP cost reduction. 1 or 2 ATK lines is fine too, since FR contributes damage as well.
              </p>
            ...
            <div class="divider  "></div>
            <h2 class="text-lg sm:text-xl font-semibold text-center  text-sky-400"> DPS STIGMA OPTIONS </h2>
            <div class="flex flex-col justify-center items-center">
              ...
              <div class="p-4 mt-4 bg-linear-to-r from-rose-950/75 to-rose-900/75 rounded-sm">
                ...
                <p class="text-sm sm:text-base text-left mb-4">
                  <b>G4 Handel</b><br/> Forgeable in Foundry.
                </p>
 ...
 <div class="flex flex-col justify-center items-center">
      ...
      <p class="text-sm sm:text-base text-center sm:text-left">
        This is a very old valkyrie that requires ranks and her signature weapon to perform well. Please play at a lower difficulty if FR is at a low rank and does not have Iris of Helheim equipped.
      </p>
      <div class="divider  "></div>
...
<br/>
        ...
        <div class="flex flex-col justify-center items-center">
          ...
          <h4 class="text-base sm:text-base text-white">Iris of Helheim + Handel set</h4>
          </div>


          <div class="p-4 mt-4 bg-linear-to-r from-purple-950/75 to-purple-900/75 rounded-sm">
            <p class="text-sm sm:text-base text-left">
              Best set for Elysian Realm.
            </p>
          </div>
          {/if}
