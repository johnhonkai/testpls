...
<svelte:head>
    <title>Rozaliya - Molotov Cherry</title> 
    <meta property="og:title" content="Rozaliya - Molotov Cherry" />
    <meta property="og:description" content="Molotov Cherry Guide, Builds and Gameplay" />
    <meta property="og:image" content="https://i.imgur.com/IdjGZoJ.png" />
    <meta property="og:url" content="https://marisaimpact.com/valk/molotov-cherry" />
...
<section class="relative mx-auto flex flex-row items-center justify-center px-4 md:p-2 gap-3 md:pb-0  md:mt-0  pt-4	sm:pt-0	">
  ...
  <div class="relative  w-auto h-48 sm:h-60 md:h-72 flex justify-center " id="valkpicbox">
    ...
    <img src="/images/valkfull/mc.png" alt="Sirin" class="h-full w-auto object-cover md:object-contain  " style ="view-transition-name: valkyrie-image-51;"/> 
  ...
  <div class="flex flex-col items-center text-center justify-start">
    ...
    <div >
    <h1 class="text-xl md:text-2xl text-slate-100 font-bold text-center leading-4 mb-4 sm:mb-1">Molotov Cherry</h1>
  </div>
    <!-- Character Name and Release Date -->
    <p class="text-base md:text-md text-center md:block hidden text-slate-300 my-2">Rozaliya | Release Date: v3.1 (23 May 2019)  </p>
    ...
    <div class="w-full max-w-sm mb-2">
      ...
      <div class="flex flex-col items-center">
        <div class="flex w-[260px] md:w-[300px] gap-2 flex-wrap justify-center outline outline-pink-500 outline-1 bg-pink-950/75 rounded-lg p-2 backdrop-blur-xs">
          ...
          <img src="/images/type/IconPSI.png" alt="BIO" class="w-auto h-8 md:h-10" />
  ...
  <div class="p-4 sm:p-4 bg-base-100 rounded-lg">
    ...
    <div>
        ...
        <ul class="list-disc ml-6 text-sm sm:text-base ">
          <li>Molotov Cherry (MC) is a silly Physical DPS that can spin to win.</li>
          <li>If <a href="/valk/blueberry-blitz" class="link text-blue-300">Liliya Blueberry Blitz</a> is on the same team, MC's attacks become stronger and Liliya will appear in the attack animations. You also gain access to a new Ultimate.</li>
          <li>MC has an upgraded form - <a href="/valk/ft" class="link text-pink-300">Fervent Tempo.</a></li>
        ...
        <ul class="list-disc ml-6 text-sm sm:text-base ">
          <li ><strong>Molotov Cherry:</strong> Open World, Expedition, Dorm Supply, Dorm Shop, Elysian Shop.</li>
...
{/if}
  ...
  {/if}
      ...
      <div class=" gap-6 mt-5 mb-10">
        ...
        <div class="bg-gray-800 p-4 rounded-lg shadow-md">
          <h2 class="text-xl  font-semibold mb-4 text-left text-slate-100 cooltext">Rozaliya Avatar</h2>
          ...
          <div class="relative overflow-hidden" style="padding-top: 56.25%;">
            ...
            loading="lazy" 
                ...
                class="absolute top-0 left-0 w-full h-full"
                src="https://www.youtube.com/embed/MjLuioFsKKU"
                title="YouTube video player"
                frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen>
