...
<svelte:head>
  <title>Sushang - Jade Knight</title> 
    ...
    <meta property="og:image" content="https://i.imgur.com/dXx9KpG.png" />
...
<section class="relative mx-auto flex flex-row items-center justify-center px-4 md:p-2 gap-3 md:pb-0  md:mt-0  pt-2	sm:pt-0	">
  ...
  <div class="flex flex-col items-center text-center justify-start">
    ...
    <p class="text-base md:text-md text-center md:block hidden text-slate-300 my-2">Li Sushang | Release Date: v6.1 (27 Oct 2022)  </p>
