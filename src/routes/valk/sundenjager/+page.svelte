...
<svelte:head>
    <title>Kallen - Sündenjäger</title> 
    <meta property="og:title" content="Kallen - Sündenjäger" />
    <meta property="og:description" content="Kallen - Sündenjäger Guide, Builds and Gameplay" />
    <meta property="og:image" content="https://i.imgur.com/O3trQFI.png" />
    <meta property="og:url" content="https://marisaimpact.com/valk/sundenjager" />
...
<CharacterLayout
  charName="sj"
  initialLikes={likesData["sj"] || 0}
  accent="bg-red-800"
  image="/images/valkfull/Sundenjager.png"
  alt="Sündenjäger "
  valk="false"
  ...
  releaseEN="v2.6.5 (28 Dec 2018)"
  releaseCN="v2.6 (13 Sep 2018)"  

>
  <!-- Tags / Type Row -->
  <CharBio mode="dps" rank="a" type="mech" element="phy"  bg="bg-red-800"/>
  ...
  <div class="p-4 sm:p-4 bg-base-100 rounded-lg">
    ...
    <div>
        ...
        <p class="mt-4 text-sm sm:text-base">
          <strong class="text-amber-400">Orbital Bombardment DPS</strong>
          <br/>
          
          
      </p>
        <ul class="list-disc ml-6 text-sm sm:text-base ">
          <li> Sundenjager was known as a cool battlesuit that fires orbital bombardment. </li>
          <li> She was not known as a good valk.</li>
        ...
        <ul class="list-disc ml-6 text-sm sm:text-base ">
          <li ><strong>Sundenjager:</strong> Open World, Expedition, Dorm Supply, Dorm Shop, Elysian Shop.</li>
...
{/if}
  ...
  {/if}
      ...
      <div>
              ...
              <h4 class="text-base sm:text-base text-white"> Domain of the Void + G4 Bianka Theater</h4>
              </div>
           ...
           <div class="divider"></div>
              ...
              <h2 class="text-xl font-semibold text-center  ">ORIGINAL GEARS</h2>
              ...
              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/24/76361817/68ed7d5e6f7934db6ac2042281404f11_7135695588939229722.png" alt="Cecilia Youth T" class="w-full h-full object-cover">

              </div>

              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/24/76361817/9341bf6a2f59d9da863e957a663119dd_1158102693637472764.png" alt="Cecilia Youth T" class="w-full h-full object-cover">

              </div>


              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/24/76361817/2a6c5dfdba0b34ae9d5bd73696543815_8633763647358339869.png" alt="Cecilia Youth M" class="w-full h-full object-cover">

              </div>

              
              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/24/76361817/136351a14a5cf3aec5a602b39605eced_8437919989432159430.png" alt="Cecilia Youth B" class="w-full h-full object-cover">
            </div>

              </div>  
              <h4 class="text-base sm:text-base text-white">Blooded Saints + Zorro</h4>
              </div>
  ...
  {/if}
      ...
      <div class=" gap-6 mt-5 mb-10">
        ...
        <div class="bg-gray-800 p-4 rounded-lg shadow-md">
          <h2 class="text-xl  font-semibold mb-4 text-left text-slate-100 cooltext">Clearing Old Abyss</h2>
          ...
          <div class="relative overflow-hidden" style="padding-top: 56.25%;">
            ...
            loading="lazy" 
                ...
                class="absolute top-0 left-0 w-full h-full"
                src="https://www.youtube.com/embed/uEB9muIepMg"
                title="YouTube video player"
                frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen>
