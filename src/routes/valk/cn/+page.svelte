...
<svelte:head>
  <title>Chrono Navi</title> 

    <meta property="og:title" content="Chrono Navi"/>
    <meta property="og:description" content="Chrono Navi Guide, Builds and Gameplay" />
    <meta property="og:image" content="https://i.imgur.com/Z2Ricw1.png" />
    <meta property="og:url" content="https://marisaimpact.com/valk/cn" />
...
function selectTabMobile(event) {
  ...
  let celikes = likesData["cn"] || 0; // Get initial likes from JSON
  const charName = "cn"; // Route name for this character
...
<div class="relative  w-auto h-48 sm:h-60 md:h-72 flex justify-center " id="valkpicbox">
  ...
  <img src="/images/valkfull/cn.webp" alt="Sparkle" class="h-full w-auto object-cover md:object-contain  " style ="view-transition-name: valkyrie-image-22;"/> 
...
<div class="flex flex-col items-center text-center justify-start">
  ...
  <div>
  <h1 class="text-xl md:text-2xl text-slate-100 font-bold text-center leading-4 mb-4 sm:mb-0">Chrono Navi</h1>
</div>
  <!-- Character Name and Release Date -->
  <p class="text-base md:text-md custom-font mb-2 text-center tracking-wider sm:block hidden text-slate-100">Ai Hyperion Λ | Release Date: v6.2 (8 Dec 2022)
...
<section class="max-w-[960px] mx-auto flex flex-col gap-1 sm:p-1 mb-6 ">
  ...
  <div class="p-4 sm:p-4 bg-base-100 rounded-lg">
      ...
      <div>
          ...
          <p class="text-sm sm:text-base mt-4">
              <strong class="text-amber-400">P1 Fire / Ignite Support</strong><br/> Chrono Navi (CN) is a Part 1 fire support who can also inflict huge ignite trauma. <br/>
              Currently, CN has been replaced by Sparkle, but CN remains as a f2p option for Part 1 teams.
          </p>
          ...
          <p class="mt-4 text-sm sm:text-base">
              <strong class="text-amber-400">New Players on Chrono Navi</strong>
              <br/> - Farm <a href="/valk/coralie" class="link ">Coralie Valkyrie Blastmetal</a>               first from Asterite Shop and Open World since she can fit in any Astral Ring team. If you have extra Asterite, then you can consider getting Chrono Navi for Elysian Ream first-clear crystal rewards.
              <br/> - Once you breakthrough Lv80+, you will encounter stages that require ignite, or enemies with huge ignite trauma in Abyss. For new players, Chrono Navi is one of your farmable options to easily apply ignite. If you don't have any valkyrie that can apply ignite, you can farm Chrono Navi to counter the ignite mechanic.
            </p>

            <p class="mt-4 text-sm sm:text-base mb-2">
              <strong class="text-amber-400">New Players on Chrono Navi Equipment</strong><br/> 
              Only use your crystal to pull Part 2 valkyries, since they use a new Astral Ring system. If CN's gears are available through other means, such as spending event or Battle Pass, you can consider getting them that way.
          </p>

          <p class="mt-4 text-sm sm:text-base">
              <strong class="text-amber-400">Competitive</strong><br/>               Chrono Navi has been replaced by Sparkle.
          ...
          <div class="relative overflow-hidden" style="padding-top: 56.25%;">
            <iframe
                ...
                src="https://www.youtube.com/embed/AJNNXCvnyKw"
  ...
  {/if}
      ...
      <div>
              ...
              <div class="flex flex-wrap my-2 rounded-lg overflow-hidden w-fit gap-1">
                ...
                <div class="w-20 h-20 sm:w-28 sm:h-28">
                  <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2022/11/11/50494840/c80b606029a5bc9d6eaf1b8d650f4de5_7381857730572632570.png?x-oss-process=image/quality,q_75/resize,s_120" alt="Rudder in Dream" class="w-full h-full object-cover">

                </div>

                  <div class="w-20 h-20 sm:w-28 sm:h-28">
                    <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2022/11/04/282941837/93e39a66c25f74901aa39f81c3450a07_2913702117931858234.png?x-oss-process=image/quality,q_75/resize,s_120" alt="Ai T" class="w-full h-full object-cover">

                  </div>


                  <div class="w-20 h-20 sm:w-28 sm:h-28">
                    <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2022/11/05/282941837/a795ddf2fbcb37e266f43abaa57000da_5105748610043118336.png?x-oss-process=image/quality,q_75/resize,s_120" alt="Ai M" class="w-full h-full object-cover">

                  </div>

                  
                  <div class="w-20 h-20 sm:w-28 sm:h-28">
                    <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2022/11/05/282941837/a287ec6320ce1a29da5d5f76212597c0_2719160241998853140.png?x-oss-process=image/quality,q_75/resize,s_120" alt="Ai B" class="w-full h-full object-cover">
                </div>

              </div>  
              <h4 class="text-base sm:text-base text-white">Rudder in Dream + Ai: Idol Transformation set</h4>
              </div>


              <div class="p-4 mt-4 bg-gradient-to-r from-blue-950/75 to-blue-900/75 rounded">
                <p class="text-sm sm:text-base text-left mb-4">
                  <b>Rudder in Dream</b><br/> Huge buffs.
                </p>
              
                <p class="text-sm sm:text-base text-left mb-4">
                  <b>Ai: Idol Transformation </b><br/> Huge buffs. Mid piece increases ignite trauma by 25%.
                </p>
      ...
      <div class="flex justify-center gap-4 my-6">
        ...
        <h2 class="text-xl md:text-2xl font-semibold mb-0 md:mb-2 text-center sm:text-left text-blue-400">Standard Chakram Playstyle</h2> 
        ...
        <div class="flex shadow-md relative space-x-4 p-2 rounded items-center w-fit  bg-gradient-to-r from-purple-500/75 to-cyan-500/0 overflow-hidden">
          ...
          <div class="absolute z-0 w-auto h-full top-0 left-0 opacity-50 mix-blend-overlay ">
            ...
            <div class="flex flex-col space-y-2 pr-2 z-10">
              <p class="text-sm sm:text-lg text-slate-100"> <b>Start:</b>  Succession + Time Crystal </p>
              <p class="text-sm sm:text-lg text-slate-100"> <b>Optional:</b> Blade Piece</p>
        ...
        <div class="mt-3 rounded" >
          <p class="text-sm sm:text-base text-left">
            ...
            <li class="text-sm sm:text-base"> Normal mode: As an A-rank, Chrono Navi is weak, especially without gears. Play at a lower difficulty, and get as many signets as you can. You can get both Ego signets at the start by using Thorny Crown sigil, OR by resetting Floor 1 until you get another Ego portal, OR use Because of You support sigil and get the other two Ego signets on Floor 7.</li>
        </p>
          </div>
        ...
        <ol class="list-decimal px-4 mb-6 text-sm sm:text-base">
          <li>Use weapon skill, then spam ATK to parry chakram until you get 3 stacks (green icon above your HP bar)</li>
          <li>Use Combo ATK, then press weapon to parry the chakrams.</li>
          <li>If you have enough sp, use Ultimate. Then, use Combo ATK, then press weapon to parry the chakrams.</li>
          <li>Repeat.</li>
        </ol>
        ...
        <div class="relative overflow-hidden" style="padding-top: 56.25%;">
            <iframe
                class="absolute top-0 left-0 w-full h-full"
                src="https://www.youtube.com/embed/zqAcBGGWCA4"
                title="YouTube video player"
                frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen
        ...
        <h2 class="text-xl md:text-2xl font-semibold mb-0 md:mb-2 text-center sm:text-left text-blue-400">Split Chakram Playstyle</h2> 
        <p class="text-sm sm:text-base text-center sm:text-left">
          You split the chakrams. You can barely see the split chakram.
        </p>
        ...
        <div class="flex shadow-md relative space-x-4 p-2 rounded items-center w-fit  bg-gradient-to-r from-purple-500/75 to-cyan-500/0 overflow-hidden">
          ...
          <div class="absolute z-0 w-auto h-full top-0 left-0 opacity-50 mix-blend-overlay ">
            ...
            <!-- Right side text sections -->
            <div class="flex flex-col space-y-2 pr-2 z-10">
              <p class="text-sm sm:text-lg text-slate-100"> <b>Start:</b>  Constant + Time Crystal</p>
              <p class="text-sm sm:text-lg text-slate-100"> <b>Optional:</b> Final Dream</p>
        ...
        <div class=" mt-3 rounded" >
          ...
          <ol class="list-decimal px-4 mb-6 text-sm sm:text-base">
            <li>Use weapon skill, then spam ATK to parry chakram until you get 3 stacks (green icon above your HP bar)</li>
            <li>Use Combo ATK, then press weapon to parry the chakrams.</li>
            <li>If Ult is available, use Ultimate.</li>
            <li>Repeat.</li>
          </ol>
        ...
        <div class="relative overflow-hidden" style="padding-top: 56.25%;">
            <iframe
                class="absolute top-0 left-0 w-full h-full"
                src="https://www.youtube.com/embed/TL-mrp8eq3E"
                title="YouTube video player"
                frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen
    ...
    <div class=" gap-6 mt-5 mb-10">
      ...
      <div class="bg-gray-800 p-4 rounded-lg shadow-md">
        <h2 class="text-xl  font-semibold mb-2 text-left text-slate-100 cooltext">Chrono Navi Support</h2>

        <p class="text-gray-200 mt-2 mb-4 text-sm sm:text-base">Supporting Fenghuang of Vicissitude and Dea Anchora</p>
