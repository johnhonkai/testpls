...
<svelte:head>
    <title>Sakura - Flame Sakitama</title> 
    <meta property="og:title" content="Sakura - Flame Sakitama" />
    <meta property="og:description" content="Sakura - Flame Sakitama Guide, Builds and Gameplay" />
    <meta property="og:image" content="https://i.imgur.com/pG2t8Xs.png" />
    <meta property="og:url" content="https://marisaimpact.com/valk/flame-sakitama" />
...
<CharacterLayout
  charName="Flame Sakitama"
  initialLikes={likesData["Flame Sakitama"] || 0}
  accent="bg-red-800"
  image="/images/valkfull/Flame Sakitama.png"
  alt="Flame Sakitama"

  titleEN="Flame Sakitama"
  titleCN="真炎幸魂"
...
>
  <!-- Tags / Type Row -->
  <CharBio mode="dps" rank="a" type="bio" element="fire"  bg="bg-red-800"/>
  ...
  <div class="p-4 sm:p-4 bg-base-100 rounded-lg">
    ...
    <div>
        ...
        <p class="mt-4 text-sm sm:text-base">
          <strong class="text-amber-400">Samurai Fire DPS</strong>
          <br/>
        ...
        <ul class="list-disc ml-6 text-sm sm:text-base ">
          <li ><strong>Flame Sakitama:</strong> Open World, Expedition, Dorm Supply, Dorm Shop, Elysian Shop.</li>
          <li ><strong>Ruinous Sakura:</strong> Exchange Shop, Battle Pass.</li>
      ...
      <div>
              ...
              <div class="flex flex-wrap my-2 rounded-lg overflow-hidden w-fit gap-1">
                ...
                <div class="w-20 h-20 sm:w-28 sm:h-28">
                  <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/07/81417673/65a3ee23c80b008bd4b72eb79c5248fc_4340942778450746284.png" alt="Path to Acheron" class="w-full h-full object-cover">
              </div>
              ...
              <h4 class="text-base sm:text-base text-white"> Ruinous Sakura + G4 Little Joys</h4>
              </div>
        ...
        <div class="bg-gray-800 p-4 rounded-lg shadow-md">
          ...
          <div class="relative overflow-hidden" style="padding-top: 56.25%;">
            ...
            loading="lazy" 
                ...
                src="https://www.youtube.com/embed/fSC3_N3YtM8"
