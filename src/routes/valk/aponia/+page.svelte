...
<svelte:head>
  <title>Aponia - Disciplinary Perdition</title> 

    <meta property="og:title" content="Aponia - Disciplinary Perdition" />
    <meta property="og:description" content="Disciplinary Perdition Guide, Builds and Gameplay" />
    <meta property="og:image" content="" />
    <meta property="og:url" content="https://marisaimpact.com/valk/aponia" />
...
function selectTabMobile(event) {
  ...
  let fovlikes = likesData["aponia"] || 0; // Get initial likes from JSON
  const charName = "aponia"; // Route name for this character
...
<section class="relative mx-auto flex flex-row items-center justify-center px-4 md:p-2 gap-3 md:pb-0  md:mt-0  pt-2	sm:pt-0	">
  ...
  <div class="relative  w-auto h-48 sm:h-60 md:h-72 flex justify-center " id="valkpicbox">
    ...
    <img src="/images/valkfull/aponia.webp" alt="Sirin" class="h-full w-auto object-cover md:object-contain  " style ="view-transition-name: valkyrie-image-28;"/> 
  ...
  <div class="flex flex-col items-center text-center justify-start">
    ...
    <div class="w-full max-w-sm mb-2">
      ...
      <div class="flex flex-col items-center">
        <div class="flex w-[260px] md:w-[300px] gap-2 flex-wrap justify-center outline outline-amber-500 outline-1 bg-amber-950/75 rounded-lg p-2 backdrop-blur-xs">
  ...
  <div class="p-4 sm:p-4 bg-base-100 rounded-lg">
    ...
    <div>
        ...
        <p class="mt-2 text-sm sm:text-base">
            <strong class="text-amber-400">Outdated Part 1 Lightning DPS</strong> <br/>
            - Aponia is an old Lightning DPS with an interesting playstyle where she can continously deal damage while supports are on the field.<br/>
            - Very easy to play, just press Combo and Ult and watch her fly around and summon lightning bolts.
        </p>
      ...
      <div class="relative overflow-hidden" style="padding-top: 56.25%;">
          <iframe
              ...
              src="https://www.youtube.com/embed/WlrcdF1zV8g"
...
{/if}
  ...
  {/if}
      ...
      <div>
              ...
              <div class="flex flex-wrap my-2 rounded-lg overflow-hidden w-fit gap-1">
                ...
                <div class="w-20 h-20 sm:w-28 sm:h-28">
                  <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2022/04/18/50494840/bd41d0bd61ba250055fb999967fabb94_8933200254054586727.png?x-oss-process=image/quality,q_75/resize,s_120" alt="Vita" class="w-full h-full object-cover">
              </div>

              <div class="w-20 h-20 sm:w-28 sm:h-28">
                  <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2022/04/18/50494840/87bfd004bdcc6f00486e96640e793e34_6940096454143340554.png?x-oss-process=image/quality,q_75/resize,s_120" alt="Vita" class="w-full h-full object-cover">
              </div>
              ...
              <h4 class="text-base sm:text-base text-white"> Lost Conviction + Zeno set</h4>
              </div>
           ...
           <div>
            ...
            <div class="p-4 mt-4 bg-linear-to-r from-orange-950/75 to-orange-900/75 rounded-sm">
              <p class="text-sm sm:text-base text-left mb-4">
                <b>Lost Conviction </b><br/>Pure damage buffs.
              </p>
            
              <p class="text-sm sm:text-base text-left mb-4">
                <b>Zeno</b><br/> Big buffs. Mid has evasion cd reduction. 3PC has sp regen.
              </p>
            ...
            <div>
              ...
              <h4 class="text-base sm:text-base text-white"> G4 Handel</h4>
              </div>
           ...
           <div>
            ...
            <div class="p-4 mt-4 bg-linear-to-r from-blue-950/75 to-blue-900/75 rounded-sm">
              <p class="text-sm sm:text-base text-left">
                Next best option. Reminder two Handels do not stack, in case you are using Eden with Handel too.
              </p>
            </div>
            ...
            <div class="flex flex-col justify-center items-center">
              ...
              <div class="p-4 mt-4 bg-linear-to-r from-blue-950/75 to-blue-900/75 rounded-sm">
                <p class="text-sm sm:text-base text-left">
                  G3 Zhenyi is forgeable in Foundry.
                </p>
              </div>
      ...
      <div class="flex justify-center gap-4 my-6">
        ...
        <div class="flex shadow-md relative space-x-4 p-2 rounded-sm items-center w-fit  bg-linear-to-r from-purple-500/75 to-cyan-500/0 overflow-hidden">
          ...
          <div class="absolute z-0 w-auto h-full top-0 left-0 opacity-50 mix-blend-overlay ">
            ...
            <div class="flex flex-col space-y-2 pr-2 z-10">
              <p class="text-sm sm:text-lg text-slate-100"> <b>Start:</b> Admonition + Shelter</p>
              <p class="text-sm sm:text-lg text-slate-100"> <b>Optional:</b> Inclusiveness </p>
            </div>
          </div>
        ...
        <div class="mt-3 rounded-sm" >
          <p class="text-sm sm:text-base text-left">
            Aponia starts with two Ego signets. Inclusiveness speeds up your rotation, it's really good. If you are playing ER Lite mode, try resetting for Ego portal.
          </div>
          ...
          <div class="flex flex-wrap gap-2 justify-center sm:justify-start">
            <!-- First Signet with 'Start' text -->
              ...
              <div class="flex flex-col items-center  p-1 rounded-sm relative border border-slate-500">
                <img src="/images/signets/Signets of Deliverance (Kevin).png" alt="Signet 5" class="w-16 h-16 sm:w-20 sm:h-20 object-cover">
                <p class="text-lg font-semibold ">2</p>
              </div>
          ...
          <div class="flex flex-col items-center p-1 rounded-sm relative border border-slate-500 ">
              <div class="flex flex-row rounded-sm">
                  <img src="/images/sigils/Proof_of_Good_and_Evil.webp" alt="Goblet" class="w-16 h-16 sm:w-20 sm:h-20 object-cover">
                  <img src="/images/sigils/Dreamful_Gold.webp" alt="Because of You" class="w-16 h-16 sm:w-20 sm:h-20 object-cover">
              </div>
              <p class="text-base sm:text-lg font-semibold">FINAL</p>
          </div>
          ...
          <li>Press weapon to summon illusion. Then, use Lightning Empress for sp, then use Ultimate</li>
          <li>If you don't have Inclusiveness Ego signet: Spam Basic ATK, when weapon button flashes, use weapon skill. Repeat until Redemption is full</li>
          <li>If you have Inclusiveness Ego signet: Ult will restore full Redemption</li>
          <li>Use Combo ATK and watch Aponia fly~</li>
          <li>Press ATK and weapon a few more times until Ult is available again</li>
          <li>Repeat</li>
        </ol>
        ...
        <div class="relative overflow-hidden" style="padding-top: 56.25%;">
            <iframe
                class="absolute top-0 left-0 w-full h-full"
                src="https://www.youtube.com/embed/O12AkoMSdms"
                title="YouTube video player"
                frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen
        ...
        <h2 class="text-xl md:text-2xl font-semibold mb-0 md:mb-2 text-center sm:text-left text-blue-400">Illusion Playstyle</h2> 
        <p class="text-sm sm:text-base text-center sm:text-left">
          This playstyle is a lot weaker. It's not even that different from the first one. Or I just don't know how to optimize this build.
        </p>
        ...
        <div class="flex shadow-md relative space-x-4 p-2 rounded-sm items-center w-fit  bg-linear-to-r from-purple-500/75 to-cyan-500/0 overflow-hidden">
          ...
          <div class="absolute z-0 w-auto h-full top-0 left-0 opacity-50 mix-blend-overlay ">
            ...
            <!-- Right side text sections -->
            <div class="flex flex-col space-y-2 pr-2 z-10">
              <p class="text-sm sm:text-lg text-slate-100"> <b>Start:</b> Atonement + Inclusiveness</p>
              <p class="text-sm sm:text-lg text-slate-100"> <b>Optional:</b> Rescue </p>
            </div>
          </div>
        </div>
        <div class="mt-3 rounded-sm" >
          <p class="text-sm sm:text-base text-left">
            Aponia starts with two Ego signets. 
          </div>
        ...
        <div class="relative overflow-hidden" style="padding-top: 56.25%;">
            <iframe
                class="absolute top-0 left-0 w-full h-full"
                src="https://www.youtube.com/embed/ERvtcefqgDo"
                title="YouTube video player"
                frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen
          ...
          <table class="table table-zebra w-full bg-gray-800 rounded-lg shadow-md text-base">
            ...
            <tbody>
              ...
              <tr>
                <td >S1</td>
                <td>
                  In Predictor's Sentence, Total DMG +19.2% ➔ 30%
                </td>
                <td class="p-3">DPS</td>
              </tr>
              <!-- Sample Row 2 -->
              <tr>
                <td>S2</td>
                <td>
                 - UNLOCK: Inhibitor's Adjudication's Lightning DMG multiplier increases to 300% ATK and sp regen increases to 5.
                 <br/>
                 - Evasion skill makes enemies take 15% ➔ 18% more Lightning DMG (independent multiplier).
              ...
              <tr>
                <td>S3</td>
                <td>
                  Leader Skill: Team ranged Lightning DMG +28% ➔ 32%, Total DMG +12% ➔ 14.7%.
                </td>
                <td>DPS</td>
              ...
              <tr>
                <td>SS</td>
                <td>
                  - UNLOCK: Inhibitor's Adjudication Lightning DMG +45%, and exiting Predictor's Sentence restore 15 sp.
                  <br/>
                  - Summoner's Promise Total DMG +15% ➔ 30%, CD reduced by 3s ➔ 4s.
                </td>
                <td> DPS</td>
              </tr>
              <tr>
                <td>SS1</td>
                <td>
                  Exiting Predictor's Sentence grants Ultimate Total DMG +27.1% ➔ 35%.
                </td>
            ...
            <td> DPS </td>
              ...
              <tr>
                <td>SS2</td>
                <td>
                  Evasion skill makes enemies take 18% ➔ 24% more Lightning DMG (independent multiplier).
                </td>
                <td> DPS </td>
              </tr>
              <tr>
                <td>SS3</td>
                <td>
                  Leader Skill: Team ranged Lightning DMG +32% ➔ 40%, Total DMG +14.7% ➔ 20%.
              ...
              <tr>
                <td>SSS</td>
                <td>
                  - UNLOCK: In Conviction, Good and Evil, Absolute triggered by teammates on the field deals additional Lightning DMG, the multiplier is increased from 135% to 150% ATK.
                  <br/>
                  - QTE: Deal 1665% ➔ 1800% ATK of Lightning DMG
                </td>
                <td> DPS</td>
              </tr>
            </tbody>
  ...
  {/if}
      ...
      <div class="flex flex-col justify-center items-center">
        ...
        <div class="flex flex-wrap my-2 rounded-lg overflow-hidden w-fit gap-1">
            ...
            <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="/images/valkportrait/Aponia Disciplinary Perdition.png" alt="Vita" class="w-full h-full object-cover">
            </div>

        </div>  
        <p class="text-sm sm:text-base text-white">Aponia Passive subskill 3</p>
    ...
    <div class="text-center my-4 rounded-sm bg-gray-700">
      <p class="text-left text-sm sm:text-base px-2 py-3">
        <b>In-Game Text:</b><br/>
       Triggering Ultimate Evasion skill makes enemies receive 21% bonus Lightning DMG from her for 12s (cannot stack) ...
      </p>
    </div>
    ...
    <div class="text-center my-4 rounded-sm bg-cyan-800">
      <p class="text-left text-sm sm:text-base px-2 py-3 text-slate-100">
        ...
        Triggering Ultimate Evasion skill makes enemies receive 21% bonus Lightning DMG from her for 12s <b>(independent multiplier) </b>...
      </p>
    </div>

    <div class="divider  "></div>

    <p class="text-sm sm:text-base text-white text-center">Aponia Ultimate subskill 2</p>
  ...
  <div class="text-center my-4 rounded-sm bg-gray-700">
    <p class="text-left text-sm sm:text-base px-2 py-3">
      <b>In-Game Text:</b><br/>
     In Conviction, [Good and Evil, Absolute] triggered by teammates on the field deal 15% ATK of bonus Lightning DMG.
    </p>
  </div>
  ...
  <div class="text-center my-4 rounded-sm bg-cyan-800">
    <p class="text-left text-sm sm:text-base px-2 py-3 text-slate-100">
      <b>Correct Translation:</b><br/>
      The rank up text got it correctly, but the skill text isn't quite correct. <br/>
      In Conviction, the Lightning DMG multiplier of [Good and Evil, Absolute] triggered by teammates is increased by an additional 15%.
    </p>

    <p class="text-left text-sm sm:text-base px-2 pb-3 text-slate-100">
      Clarification: The base Lightning DMG multiplier of [Good and Evil, Absolute] is 135% ATK, stated in Combo ATK. This subskill increases the dmg multiplier = 135 + 15 = 150% ATK of Lightning DMG. The in-game text makes it sound like the skill will deal another additional Lightning DMG.
    </p>
  </div>
  ...
  <div class="divider  "></div>
    ...
    <div class="flex flex-col justify-center items-center">
      ...
      <p class="text-sm sm:text-base text-white">Lost Conviction - Passive 1</p>
  ...
  <div class="text-center my-4 rounded-sm bg-gray-700">
    <p class="text-left text-sm sm:text-base px-2 py-3">
      <b>In-Game Text:</b><br/>
     ... Thunderstorms that continue striking in Predictor's Sentence deal 45% ATK of bonus Lightning DMG.
    </p>
  </div>
  ...
  <div class="text-center my-4 rounded-sm bg-cyan-800">
    <p class="text-left text-sm sm:text-base px-2 py-3 text-slate-100">
      <b>Correct Translation:</b><br/>
      ... Lightning DMG multiplier of Thunderstorms that continue striking in Predictor's Sentence is increased by an additional 45% ATK.
    </p>
    <p class="text-left text-sm sm:text-base px-2 pb-3 text-slate-100">

    Clarification: The thunderstorm's base dmg multiplier is 125% ATK, stated in Combo ATK. This weapon passive increases the thunderstorm's dmg multiplier = 125 + 45 = 170% ATK of Lightning DMG. The in-game text makes it sound like the thunderstorm will deal another additional Lightning DMG.
  </p>
  </div>
      {/if}
