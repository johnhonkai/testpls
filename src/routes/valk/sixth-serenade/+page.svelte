...
<svelte:head>
    <title>Kallen - Sixth Serenade</title> 
    <meta property="og:title" content="Kallen - Sixth Serenade" />
    <meta property="og:description" content="Kallen - Sixth Serenade Guide, Builds and Gameplay" />
    <meta property="og:image" content="https://i.imgur.com/sqPhW5j.png" />
    <meta property="og:url" content="https://marisaimpact.com/valk/sixth-serenade" />
...
<CharacterLayout
  charName="Sixth Serenade"
  initialLikes={likesData["Sixth Serenade"] || 0}
  accent="bg-violet-800"
  image="/images/valkfull/Sixth Serenade.png"
  alt="Sixth Serenade"
  valk="false"

  titleEN="Sixth Serenade"
  titleCN="第六夜想曲"
...
>
  <!-- Tags / Type Row -->
  <CharBio mode="dps" rank="s" type="psy" element="ice"  bg="bg-violet-800"/>
  ...
  <div class="p-4 sm:p-4 bg-base-100 rounded-lg">
    ...
    <div>
        ...
        <p class="mt-4 text-sm sm:text-base">
          <strong class="text-amber-400">AOE Ice DPS</strong>
          <br/>
        ...
        <p class="mt-4 text-sm sm:text-base">
          ...
          <br/>
You can farm 6S in War Treasury. All valks in War Treasury are outdated, so you can unlock whoever you like first. Consider unlocking 6S for Elysian Realm first-clear crystal rewards.
        ...
        <ul class="list-disc ml-6 text-sm sm:text-base ">
          <li ><strong>Sixth Serenade:</strong> War Treasury, Dorm Supply, Battle Pass.</li>
          <li ><strong>Tranquil Arias:</strong> Exchange Shop, Battle Pass.</li>
          <li ><strong>G4 Willows:</strong> Exchange Shop, Battle Pass.</li>
      ...
      <div>
              ...
              <div class="flex flex-wrap my-2 rounded-lg overflow-hidden w-fit gap-1">
                ...
                <div class="w-20 h-20 sm:w-28 sm:h-28">
                  <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/24/76361817/3ef0099fe1f32a2aef6763f13589a340_6085210325776853865.png" alt="Path to Acheron" class="w-full h-full object-cover">
              </div>
              ...
              <h4 class="text-base sm:text-base text-white"> Tranquil Arias + G4 Willows</h4>
              </div>
        ...
        <div class="bg-gray-800 p-4 rounded-lg shadow-md">
          ...
          <div class="relative overflow-hidden" style="padding-top: 56.25%;">
            ...
            loading="lazy" 
                ...
                class="absolute top-0 left-0 w-full h-full"
                src="https://www.youtube.com/embed/qSuQZoluDNo"
                title="YouTube video player"
                frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen>
