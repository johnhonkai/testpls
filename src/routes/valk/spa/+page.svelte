...
<svelte:head>
  <title>Spina Astera</title> 

    <meta property="og:title" content="Rita - Spina Astera" />
    <meta property="og:description" content="Spina Astera Guide, Builds and Gameplay" />
    <meta property="og:image" content="" />
    <meta property="og:url" content="https://marisaimpact.com/valk/spa" />
...
function selectTabMobile(event) {
  ...
  let fovlikes = likesData["spa"] || 0; // Get initial likes from JSON
  const charName = "spa"; // Route name for this character
...
<section class="relative mx-auto flex flex-row items-center justify-center px-4 md:p-2 gap-3 md:pb-0  md:mt-0  pt-2	sm:pt-0	">
  ...
  <div class="relative  w-auto h-48 sm:h-60 md:h-72 flex justify-center " id="valkpicbox">
    ...
    <img src="/images/valkfull/spa2.webp" alt="Sirin" class="h-full w-auto object-cover md:object-contain  " style ="view-transition-name: valkyrie-image-32;"/> 
  ...
  <div class="flex flex-col items-center text-center justify-start">
    ...
    <div>
    <h1 class="text-xl md:text-2xl text-slate-100 font-bold text-center leading-4 mb-4 sm:mb-0">Spina Astera</h1>
  </div>
    <!-- Character Name and Release Date -->
    <p class="text-base md:text-md custom-font mb-2 text-center tracking-wider md:block hidden text-slate-100">Rita Rossweisse | Release Date: v5.5 (24 Feb 2022)  </p>
  ...
  <div class="p-4 sm:p-4 bg-base-100 rounded-lg">
    ...
    <div>
        ...
        <p class="mt-2 text-sm sm:text-base">
            <strong class="text-amber-400">Outdated Part 1 Fire DPS</strong> <br/>
            - Elegant Fire DPS that inherits the Astral Harness power from Dea Anchora.<br/>
            - Currently, Spina Astera (SPA) has been replaced by <a href="/valk/sirin" class="link ">Sirin.</a> 
        </p>
        ...
        <p class="text-sm sm:text-base mt-4 mb-4">
          <strong class="text-amber-400">F2P Players</strong> <br/> - Get <a href="/valk/sirin" class="link ">Sirin</a>  from War Treasury instead. Sirin is a farmable, more updated version of SPA.
          <br/> - Only use your crystal to pull Part 2 valkyries, since they use a new Astral Ring system. If SPA and her weapon are available through other means, such as spending event or Battle Pass, you can consider getting them that way.
      </p>
      ...
      <div class="relative overflow-hidden" style="padding-top: 56.25%;">
          <iframe
              ...
              src="https://www.youtube.com/embed/lK7jWgLjENE"
      ...
      <div>
              ...
              <div class="flex flex-wrap my-2 rounded-lg overflow-hidden w-fit gap-1">
                ...
                <div class="w-20 h-20 sm:w-28 sm:h-28">
                  <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2022/01/17/6100274/2875379e8dee52da04331af8ec3c44ba_5406050110141247839.png?x-oss-process=image/quality,q_75/resize,s_120" alt="Vita" class="w-full h-full object-cover">
              </div>

              <div class="w-20 h-20 sm:w-28 sm:h-28">
                  <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2022/01/10/6100274/7cee798ee4ed10350a48088a6ad5cef2_2347667235909744651.png?x-oss-process=image/quality,q_75/resize,s_120" alt="Vita" class="w-full h-full object-cover">
              </div>

              <div class="w-20 h-20 sm:w-28 sm:h-28">
                  <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2022/01/10/6100274/fbf2690eb47b19b728f97155aa812b44_5071011000043757418.png?x-oss-process=image/quality,q_75/resize,s_120" alt="Vita" class="w-full h-full object-cover">
              </div>

              <div class="w-20 h-20 sm:w-28 sm:h-28">
                  <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2022/01/10/6100274/c5c22b79ce47b663cee83858c7c4080b_4167396708131759812.png?x-oss-process=image/quality,q_75/resize,s_120" alt="Vita" class="w-full h-full object-cover">
              </div>

              </div>  
              <h4 class="text-base sm:text-base text-white"> Astral Divide + Ragna set</h4>
              </div>
           ...
           <div>
            ...
            <div class="p-4 mt-4 bg-gradient-to-r from-purple-950/75 to-purple-900/75 rounded">
              <p class="text-sm sm:text-base text-left mb-4">
                <b>Astral Divide </b><br/>Pure damage buff. Restore Astra meter while on standby
              </p>
            
              <p class="text-sm sm:text-base text-left mb-4">
                <b>G4 Ragna</b><br/> Pure damage buff
              </p>
           ...
           <div>
            ...
            <div class="p-4 mt-4 bg-gradient-to-r from-blue-950/75 to-blue-900/75 rounded">
              <p class="text-sm sm:text-base text-left">
                Around the same performance as Ragna
              </p>
            </div>
      ...
      <h2 class="text-2xl sm:text-3xl font-semibold bg-gradient-to-r  from-blue-700 to-blue-500 text-white rounded px-2 mb-2 text-center">ELYSIAN REALM</h2>
        ...
        <div class="flex shadow-md relative space-x-4 p-2 rounded items-center w-fit  bg-gradient-to-r from-purple-500/75 to-cyan-500/0 overflow-hidden">
          ...
          <div class="absolute z-0 w-auto h-full top-0 left-0 opacity-50 mix-blend-overlay ">
            ...
            <div class="flex flex-col space-y-2 pr-2 z-10">
              <p class="text-sm sm:text-lg text-slate-100"> <b>Start:</b> Wild Flare + Star Quillon</p>
              <p class="text-sm sm:text-lg text-slate-100"> <b>Optional:</b> Alrescha </p>
            </div>
          </div>
        ...
        <div class="mt-3 rounded" >
          <p class="text-sm sm:text-base text-left">
            ...
            <li class="text-sm sm:text-base"> Normal mode: You can complete the run with just one Ego signet (Wild Flare), but having both Ego signets is a big improvement. You can get both Ego signets at the start by using Thorny Crown sigil, OR by resetting Floor 1 until you get another Ego portal, OR use Because of You support sigil and get the other two Ego signets on Floor 7.</li>
          </p>
          </div>
          <div class="divider divider-neutral"></div>
          ...
          <li>Charged ATK ➔ Charged ATK + Weapon ➔ Do a full Basic ATK sequence ➔ Charged ATK</li>
          <li>If Ult is available: Ult ➔ Do a full Basic ATK sequence ➔ Charged ATK</li>
          <li>Repeat</li>
        </ol>
        ...
        <div class="relative overflow-hidden" style="padding-top: 56.25%;">
            <iframe
                class="absolute top-0 left-0 w-full h-full"
                src="https://www.youtube.com/embed/ebS2Vb8-LP0"
                title="YouTube video player"
                frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen
          ...
          <table class="table table-zebra w-full bg-gray-800 rounded-lg shadow-md text-base">
            ...
            <tbody>
              ...
              <tr>
                <td >S1</td>
                <td>
                  Enemies within Starshine Circle take 13% ➔ 20% bonus Fire DMG from Spina Astera (independent multiplier)
                </td>
                <td class="p-3">Independent, so it's big buff.</td>
              </tr>
              <!-- Sample Row 2 -->
              <tr>
                <td>S2</td>
                <td>
                 UNLOCK: Entering Astral Harness triggers 2s time fracture.
              ...
              <tr>
                <td>S3</td>
                <td>
                  Leader Skill: Team Combo/Charged ATK Total DMG +31%. With at least one non-MECH valk in the team, team Fire DMG +37%
                </td>
                <td>DPS</td>
              ...
              <tr>
                <td>SS</td>
                <td>
                  UNLOCK: Astral Flare: Erupt restores 10 sp.
                <td> DPS</td>
              </tr>
              <tr>
                <td>SS1</td>
                <td>
                  Astral Harness grants Total DMG +35% ➔ 40%, reduces Total DMG taken by 30% ➔ 40%
                </td>
            ...
            <td> DPS </td>
              ...
              <tr>
                <td>SS2</td>
                <td>
                  UNLOCK: Evasion skill grants Total DMG +15% for 3s, and restore 5 sp.
                </td>
                <td> DPS </td>
              </tr>
              <tr>
                <td>SS3</td>
                <td>
                  Leader Skill: Team Combo/Charged ATK Total DMG +31% ➔ 34%. With at least one non-MECH valk in the team, team Fire DMG +37% ➔ 40%.
              ...
              <tr>
                <td>SSS</td>
                <td>
                UNLOCK: Astral Flare: Erupt deals additional 150% ATK of Fire DMG.
                </td>
                <td> DPS</td>
              </tr>
            </tbody>
  ...
  {/if}
      ...
      <div class="flex flex-col justify-center items-center">
        ...
        <div class="flex flex-wrap my-2 rounded-lg overflow-hidden w-fit gap-1">
            ...
            <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="/images/valkportrait/Rita Spina Astera.png" alt="Vita" class="w-full h-full object-cover">
            </div>

        </div>  
        <p class="text-sm sm:text-base text-white">Passive subskill 1</p>
    ...
    <div class="text-center my-4 rounded bg-gray-700">
      <p class="text-left text-sm sm:text-base px-2 py-3">
        <b>In-Game Text:</b><br/>
        Enemies within Starshine Circle take 20% bonus Fire DMG from Spina Astera (cannot stack)      
      </p>
    </div>
    ...
    <div class="text-center my-4 rounded bg-cyan-800">
      <p class="text-left text-sm sm:text-base px-2 py-3 text-slate-100">
        ...
        Enemies within Starshine Circle take 20% bonus Fire DMG from Spina Astera <b>(independent multiplier) </b>...
      </p>
    </div>
      {/if}
