...
<svelte:head>
    <title>Luna Kindred</title> 
    <meta property="og:title" content="Luna Kindred" />
    <meta property="og:description" content="Luna Kindred Guide, Builds and Gameplay" />
    <meta property="og:image" content="https://i.imgur.com/V1mUA9t.png" />
    <meta property="og:url" content="https://marisaimpact.com/valk/luna-kindred" />
...
<CharacterLayout
  charName="Luna Kindred"
  initialLikes={likesData["Luna Kindred"] || 0}
  accent="bg-red-800"
  image="/images/valkfull/Luna Kindred.png"
  alt="Luna Kindred"
  valk="false"

  titleEN="Luna Kindred"
  titleCN="月下初拥"
  ...
  releaseCN="v2.4 (21 June 2018)"  

>
  <!-- Tags / Type Row -->
  <CharBio mode="dps" rank="a" type="bio" element="phy"  bg="bg-red-800"/>
  ...
  <div class="p-4 sm:p-4 bg-base-100 rounded-lg">
    ...
    <div>
        ...
        <p class="mt-4 text-sm sm:text-base">
          <strong class="text-amber-400">Small but Strong DPS</strong>
          <br/>
          
          
      </p>
        <ul class="list-disc ml-6 text-sm sm:text-base ">
          <li> Luna Kindred was a decent DPS. </li>
          <li> Marks the first valk from captainverse. </li>
        ...
        <p class="mt-4 text-sm sm:text-base">
          ...
          Luna Kindred is available in Elysian Realm - she can give first-clear crystal reward.
        ...
        <ul class="list-disc ml-6 text-sm sm:text-base ">
          <li ><strong>Luna Kindred:</strong> Open World, Expedition, Dorm Supply, Dorm Shop, Elysian Shop.</li>
          <li ><strong>Hekate's Sombre:</strong> Exchange Shop, Battle Pass.</li>
      ...
      <div>
              ...
              <div class="flex flex-wrap my-2 rounded-lg overflow-hidden w-fit gap-1">
                ...
                <div class="w-20 h-20 sm:w-28 sm:h-28">
                  <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/11/24/9917988/519f8ed24e9042f1b487728032a44e8a_8044254317476608920.png" alt="Path to Acheron" class="w-full h-full object-cover">
              </div>


              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/25/76361817/cb701147b58fa90ce2d1c697a71db069_984152816387507870.png" alt="Cecilia Youth T" class="w-full h-full object-cover">

              </div>


              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/25/76361817/421f0e3c83f15f60a082c06a829fd993_2142299996919224251.png" alt="Cecilia Youth M" class="w-full h-full object-cover">

              </div>

              
              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/10/29/77124895/3dcaf1a1544a0976ba1615f7da892de3_5632216121245093883.png" alt="Cecilia Youth B" class="w-full h-full object-cover">
            </div>

              </div>  
              <h4 class="text-base sm:text-base text-white"> Hekate Sombre + Kafka / Mich / whatever physical</h4>
              </div>
        ...
        <div class="bg-gray-800 p-4 rounded-lg shadow-md">
          ...
          <div class="relative overflow-hidden" style="padding-top: 56.25%;">
            ...
            loading="lazy" 
                ...
                class="absolute top-0 left-0 w-full h-full"
                src="https://www.youtube.com/embed/yLjCeAkTAfY"
                title="YouTube video player"
                frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen>
