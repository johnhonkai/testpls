...
<div class="flex flex-col items-center text-center justify-start">
  <!-- Battlesuit Name -->
  <h1 class="text-xl md:text-2xl text-slate-100 font-bold text-center leading-4 mb-4 sm:mb-0 mt-4">Peregrine Sword (BETA)</h1>

  <!-- Character Name and Release Date -->
  <p class="text-base md:text-md text-center md:block hidden text-slate-300 mb-2">Li Sushang | Release Date: v8.2 (24 Apr 2025)  </p>
      ...
      <div>
          ...
          <p class="mt-4 text-sm sm:text-base">
              ...
              <ul class="list-disc ml-6 text-sm sm:text-base">
                <li>The first Part 2 BIO BLEED DPS with high hitcount.</li>
                <li>Reminder that Bleed DMG is not considered as Melee or Ranged DMG, and cannot crit.</li>
                <li>All her attacks deal 3x hitcount. Also deals more hits against hitcount shield.</li>

            </ul>

            <p class="mt-4 text-sm sm:text-base">
              <strong class="text-amber-400">LoA Support</strong> <br/>To Be Updated.
          </p>
          ...
          <p class="mt-4 text-sm sm:text-base">
              <strong class="text-amber-400">New Players</strong> <br/> To Be Updated.
            </p>

            <p class="mt-4 text-sm sm:text-base">
              <strong class="text-amber-400">Existing Players</strong> <br/> To Be Updated.
            </p>

            <p class="mt-4 text-sm sm:text-base">
              <strong class="text-amber-400">Competitive</strong> <br/> To Be Updated.
            </p>
          <div class="divider divider-neutral"></div>
          <!-- How to Get Section -->
          ...
          <ul class="list-disc ml-6 text-sm sm:text-base ">
              ...
              <li><strong>Badum's Stigma:</strong> Equipment Supply, Forgeable, Free stigma box in 8.2</li>
          </ul>
          <div class="divider divider-neutral"></div>
          <!-- Full Guide Section -->
