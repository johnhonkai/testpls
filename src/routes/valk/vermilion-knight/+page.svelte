...
<svelte:head>
    <title>Himeko - Vermilion Knight: Eclipse</title> 
    <meta property="og:title" content="Himeko - Vermilion Knight: Eclipse" />
    <meta property="og:description" content="Vermilion Knight: Eclipse Guide, Builds and Gameplay" />
    <meta property="og:image" content="https://i.imgur.com/LWRfbcR.png" />
    <meta property="og:url" content="https://marisaimpact.com/valk/vermilion-knight" />
...
function selectTabMobile(event) {
  ...
  const langData: Record<Lang, { battlesuitName: string; infoLine: string ; infoLine2: string ; infoLine3: string  }> = {
    EN: {
  ...
  <div class="p-4 sm:p-4 bg-base-100 rounded-lg">
    ...
    <div>
        ...
        <p class="mt-4 text-sm sm:text-base">
          <strong class="text-amber-400">Extinguished Part 1 Fire DPS</strong>
          <br/>
        ...
        <p class="mt-4 text-sm sm:text-base">
          ...
          <br/>
          You can farm VK in War Treasury. All valks in War Treasury are outdated, so you can unlock whoever you like first. Consider unlocking VK for Elysian Realm first-clear crystal rewards.
        ...
        <ul class="list-disc ml-6 text-sm sm:text-base ">
          <li ><strong>Vermilion Knight:</strong> Dorm Supply, War Treasury, Battle Pass.</li>
          <li ><strong>An-Utu/Uriel:</strong> Exchange Shop, Battle Pass.</li>
          <li ><strong>G4 Little Joys:</strong> Foundry, Exchange Shop, Battle Pass.</li>
      ...
      <div>
              ...
              <div class="flex flex-wrap my-2 rounded-lg overflow-hidden w-fit gap-1">
                ...
                <div class="w-20 h-20 sm:w-28 sm:h-28">
                  <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/17/75216984/42c5fcf341eee3899f19a7ca70f9dc2d_4248272482276849804.png" alt="Path to Acheron" class="w-full h-full object-cover">
              </div>


              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://act-upload.mihoyo.com/bh3-wiki/2023/08/12/282941837/7df819142546acc5810989fe30c4873f_7239579905567990276.png" alt="Cecilia Youth T" class="w-full h-full object-cover">

              </div>


              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://act-upload.mihoyo.com/bh3-wiki/2023/08/12/282941837/763480600e89f9c800410a25da49ec2e_2776697066366451417.png" alt="Cecilia Youth M" class="w-full h-full object-cover">

              </div>

              
              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://act-upload.mihoyo.com/bh3-wiki/2023/08/12/282941837/8e65a0478b4e273cf49e6cd606a49483_4401041772639778296.png" alt="Cecilia Youth B" class="w-full h-full object-cover">
            </div>

              </div>  
              <h4 class="text-base sm:text-base text-white"> Shuhadaku of Uriel + G4 Little Joys set </h4>
              </div>
