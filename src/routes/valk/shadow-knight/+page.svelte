...
<svelte:head>
    <title>Fu Hua - Shadow Knight</title> 
    <meta property="og:title" content="Fu Hua - Shadow Knight" />
    <meta property="og:description" content="Fu Hua - Shadow Knight Guide, Builds and Gameplay" />
    <meta property="og:image" content="https://i.imgur.com/JanD7tA.png" />
    <meta property="og:url" content="https://marisaimpact.com/valk/shadow-knight" />
...
<CharacterLayout
  charName="Shadow Knight"
  initialLikes={likesData["Shadow Knight"] || 0}
  accent="bg-blue-800"
  image="/images/valkfull/Shadow Knight.png"
  alt="Shadow Knight"
  valk="false"

  titleEN="Shadow Knight"
  titleCN="影骑士·月轮"

  nameEN="Fu Hua"
  nameCN="符华"

  releaseEN="v2.6 (12 Dec 2018)"
  releaseCN="v2.1 (8 Feb 2018)"  

>
  <!-- Tags / Type Row -->
  <CharBio mode="dps" rank="s" type="mech" element="lightning"  bg="bg-blue-800"/>
  ...
  <div class="p-4 sm:p-4 bg-base-100 rounded-lg">
    ...
    <div>
        ...
        <p class="mt-4 text-sm sm:text-base">
          <strong class="text-amber-400">Burst Mode Lightning DPS</strong>
          <br/>
          
          
      </p>
        <ul class="list-disc ml-6 text-sm sm:text-base ">
          <li> Shadow Knight (SK) was a powerful Lightning DPS, famously known for her Oraoraora attack.</li>
          <li> SK excels in old Abyss mode: She could gather mobs in one place, and has high dmg resistance, allowing her to tank the highest bleed level.</li>
          <li> SK applies Bleed status to gain Lightning DMG buff. Some players confuses SK as a Bleed DPS, compared to the actual Lightning Bleed DPS like Lunar Vow.</li>
        ...
        <p class="mt-4 text-sm sm:text-base">
          ...
          <br/>
You can farm SK in War Treasury. All valks in War Treasury are outdated, so you can unlock whoever you like first. Consider unlocking SK for Elysian Realm first-clear crystal rewards.
        ...
        <ul class="list-disc ml-6 text-sm sm:text-base ">
          <li ><strong>Shadow Knight:</strong> War Treasury, Dorm Supply, Battle Pass.</li>
          <li ><strong>Nuada:</strong> Exchange Shop, Battle Pass.</li>
          <li ><strong>G4 Handel:</strong> Exchange Shop, Battle Pass.</li>
  ...
  {/if}
      ...
      <div>
              ...
              <div class="flex flex-wrap my-2 rounded-lg overflow-hidden w-fit gap-1">
                ...
                <div class="w-20 h-20 sm:w-28 sm:h-28">
                  <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/07/72350798/9f7411ca2e58f1a9d62d9b8731fcf66c_719581949725119223.png" alt="Path to Acheron" class="w-full h-full object-cover">
              </div>


              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2022/04/18/50494840/69197917c070e877ad922d21a3536325_2748643889039309262.png" alt="Cecilia Youth T" class="w-full h-full object-cover">

              </div>


              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2022/04/18/50494840/a6ecf711857945fdcbfb02ccace6075d_8482437261998817983.png" alt="Cecilia Youth M" class="w-full h-full object-cover">

              </div>

              
              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2022/04/18/50494840/b1c357b7a1d6d5e39fae925f7c90e724_8580284000724519020.png" alt="Cecilia Youth B" class="w-full h-full object-cover">
            </div>

              </div>  
              <h4 class="text-base sm:text-base text-white"> Nuada + G4 Handel, or whatever Lightning stigma </h4>
              </div>
           ...
           <div class="divider"></div>
              ...
              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/24/72350798/0043459e2895d057867b5f48643d0db7_938975187639994352.png" alt="Cecilia Youth T" class="w-full h-full object-cover">

              </div>


              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/24/72350798/7a6aeae8cdb4c91f02d771b741c6904a_4305726291407635884.png" alt="Cecilia Youth M" class="w-full h-full object-cover">

              </div>

              
              <div class="w-20 h-20 sm:w-28 sm:h-28">
                <img src="https://uploadstatic.mihoyo.com/bh3-wiki/2021/09/24/72350798/d4bd24ff7816eab1d1bd86499eb4c2c7_1140452510728414788.png" alt="Cecilia Youth B" class="w-full h-full object-cover">
            </div>

              </div>  
              <h4 class="text-base sm:text-base text-white"> Monet T Goemon MB</h4>
              </div>             
           </div>
      ...
      <div class=" gap-6 mt-5 mb-10">
        ...
        <div class="bg-gray-800 p-4 rounded-lg shadow-md">
          <h2 class="text-xl  font-semibold mb-4 text-left text-slate-100 cooltext">Elysian Realm</h2>
          ...
          <div class="relative overflow-hidden" style="padding-top: 56.25%;">
            ...
            loading="lazy" 
                ...
                src="https://www.youtube.com/embed/DhdinaJmxzo"
