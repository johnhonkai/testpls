...
<svelte:head>
    <title>Durandal - Valkyrie Gloria</title> 
    <meta property="og:title" content="Durandal - Valkyrie Gloria" />
    <meta property="og:description" content="Valkyrie Gloria Guide, Builds and Gameplay" />
    <meta property="og:image" content="" />
    <meta property="og:url" content="https://marisaimpact.com/valk/vg" />
...
function selectTabMobile(event) {
  ...
  let fovlikes = likesData["vg"] || 0; // Get initial likes from JSON
  const charName = "vg"; // Route name for this character
...
<section class="relative mx-auto flex flex-row items-center justify-center px-4 md:p-2 gap-3 md:pb-0  md:mt-0  pt-4	sm:pt-0	">
  ...
  <div class="relative  w-auto h-48 sm:h-60 md:h-72 flex justify-center " id="valkpicbox">
    ...
    <img src="/images/valkfull/vg.webp" alt="Sirin" class="h-full w-auto object-cover md:object-contain  " style ="view-transition-name: valkyrie-image-51;"/> 
  ...
  <div class="flex flex-col items-center text-center justify-start">
    ...
    <div >
    <h1 class="text-xl md:text-2xl text-slate-100 font-bold text-center leading-4 mb-4 sm:mb-1">Valkyrie Gloria</h1>
  </div>
    <!-- Character Name and Release Date -->
    <p class="text-base md:text-md text-center md:block hidden text-slate-300 mb-2">Durandal | Release Date: v3.8 (2 Apr 2020)  </p>
  ...
  <div class="p-4 sm:p-4 bg-base-100 rounded-lg">
    ...
    <div>
        ...
        <p class="mt-4 text-sm sm:text-base">
          ...
          <br/>
          Valkyrie Gloria (VG) is the first lance user. She was a mediocre Fire DPS, she was just meant to introduce the character Durandal.
        ...
        <p class="mt-4 text-sm sm:text-base">
          <strong class="text-amber-400 ">New Players on VG</strong>
          <br/> Expedition: Only very old valks are in expedition. VG is one of the better valks to get in expedition since she can be used for Elysian Realm first-clear crystal rewards.
        ...
        <ul class="list-disc ml-6 text-sm sm:text-base ">
          <li ><strong>Valkyrie Gloria:</strong> Expedition, Adventure Task.</li>
            <li ><strong>Sagittarius Astra (Better):</strong> Focused Supply.</li>
            <li ><strong>Eos Gloria (Original Weapon):</strong> Exchange Shop.</li>

            <li ><strong>G4 Little Joys:</strong> Forgeable in foundry.</li>
...
{/if}
  ...
  {/if}
      ...
      <div>
              ...
              <h4 class="text-base sm:text-base text-white"> Sagittarius Astra + G4 Little Joys </h4>
              </div>
