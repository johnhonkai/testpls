...
<section class="relative mx-auto flex flex-row items-center justify-center px-4 md:p-2 gap-3 md:pb-0  md:mt-0  pt-2	sm:pt-0	">
  ...
  <div class="relative  w-auto h-48 sm:h-60 md:h-72 flex justify-center " id="valkpicbox">
    ...
    <img src="/images/valkfull/Dea_Anchora.webp" alt="Sirin" class="h-full w-auto object-cover md:object-contain  " style ="view-transition-name: valkyrie-image-43;"/> 
  ...
  <div class="flex flex-col items-center text-center justify-start">
    ...
    <p class="text-base md:text-md text-center md:block hidden text-slate-300 mb-2">Durandal | Release Date: v4.5 (17 Dec 2020)  </p>
  ...
  <div class="p-4 sm:p-4 bg-base-100 rounded-lg">
    ...
    <div>
        ...
        <p class="mt-4 text-sm sm:text-base">
          <strong class="text-amber-400">Part 1 Fire DPS</strong>
          <br/>
