...
<section class="container mx-auto px-4 py-10">
  ...
  <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
    {#each filteredPosts as post} <!-- Use filteredPosts here -->
      <a href={`/beta-news/${post.slug}`} class="block p-6 bg-base-200 rounded-lg shadow-lg transition-transform transform hover:scale-105 hover:shadow-xl will-change-transform">
