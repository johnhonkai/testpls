...
<section class="pb-10 pt-5  text-white z-10 mb-40">
  <div class="xl:max-w-[var(--breakpoint-xl)] lg:max-w-[var(--breakpoint-lg)] mx-auto px-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <a href="https://www.youtube.com/watch?v=gOWs2beIPTc" id="content1" target="_blank" class="group block rounded-2xl bg-zinc-800 border border-zinc-600/50 hover:border-zinc-400 transition-colors duration-200 overflow-hidden">
        <div class="overflow-hidden h-48">
          <img src="https://i.ytimg.com/vi/gOWs2beIPTc/hqdefault.jpg" alt="Latest Video" class="w-full h-full object-cover transition-transform duration-300 group-hover:scale-110" />
        </div>
        <div class="p-4">
