...
<script lang="ts">
  ...
  function updatePatchTime() {
      const regionalStartDate = new Date('2026-8-22'); // Start date Regional Servers
      const cnStartDate = new Date('2026-7-25');       // Start date CN Servers

      const currentWeekRegional = calculateWeek(regionalStartDate);
      const currentWeekCN = calculateWeek(cnStartDate);

      regionalServerInfo = `Current: v9.0 Week ${currentWeekRegional}`;
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
        ...
        <div class="text-sm text-slate-300 space-y-4">
          <div>
            ...
            <ul class="list-disc pl-5 text-sm text-slate-300 ">
              ...
              <li>v9.1 update is on 22 Oct</li>
            </ul>
          </div>
          <div>
            <div class="text-red-400 font-semibold">CN SERVER</div>

            <ul class="list-disc pl-5 text-sm text-slate-300 ">
              <li>{cnServerInfo}</li>
              <li>v9.1 update is on 24 Sep</li>
            </ul>            
          </div>
        </div>
      </div>
      ...
      <div class="rounded-2xl border border-white/20 bg-gradient-to-b from-cyan-950 to-cyan-900 shadow-sm p-4">
        <div class="flex items-center gap-2 border-b border-white/10 pb-2 mb-3">
          ...
          <h2 class="text-lg font-semibold text-white tracking-tight">9.2 INFO DATE</h2>
        </div>
        <ul class="list-disc pl-5 text-sm text-slate-300 space-y-1">
          <li>Valk Teaser & Reveal: 29 Oct</li>
          <li>Beta v1 (Private): 30 Oct</li>
          <li>Dev Video: 5 Nov</li>
          <li>Beta v2: 6 Nov </li>
          <li>Beta v3: 13 Nov</li>
          <li>Livestream: 21 Nov</li>
          <li>Patch Day: 26 Nov </li>
...
<div class="rounded-2xl border border-white/20 bg-gradient-to-b from-cyan-950 to-cyan-900 shadow-sm p-4">
  <div class="flex items-center gap-2 border-b border-white/10 pb-2 mb-3">
    ...
    <h2 class="text-lg font-semibold text-white tracking-tight">9.1 CRYSTAL INCOME</h2>
  </div>
  ...
  <ul class="list-disc pl-5 text-sm text-slate-300 space-y-1">
    ...
    <li>25 Battlesuit/Equip Cards</li>
    <li>2 Carnival 10-Pull Cards</li>
...
<div class="flex gap-2 mt-4 mb-2 justify-center items-center flex-wrap">
  ...
  <div class="flex items-center gap-1">
    ...
    <a 
      href="https://www.miyoushe.com/bh3/article/78268890"
      target="_blank"
...
<section class="pb-10 pt-5  text-white z-10 ">
  <div class="xl:max-w-[var(--breakpoint-xl)] lg:max-w-[var(--breakpoint-lg)] mx-auto px-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <a href="https://www.youtube.com/watch?v=6a82RYlXAKA" id="news1" class="group block rounded-2xl  bg-zinc-800 border border-zinc-600/50 hover:border-zinc-400 transition-colors duration-200 overflow-hidden">
        <div class="overflow-hidden h-48">
          <img src="https://i.ytimg.com/vi/6a82RYlXAKA/hqdefault.jpg" alt="New Battlesuit" class="w-full h-full object-cover transition-transform duration-300 group-hover:scale-110" />
        </div>
        <div class="p-4">
          <h3 class="text-lg font-semibold text-white mb-1">Herrscher of Time Gameplay</h3>
          <p class="text-slate-300">Dual type again</p>
        </div>
      </a>
  
      <a href="https://youtu.be/-ky99iBljjw" id="news2" class="group block rounded-2xl bg-zinc-800 border border-zinc-600/50 hover:border-zinc-400 transition-colors duration-200 overflow-hidden">
        <div class="overflow-hidden h-48">
          <img src="https://i.ytimg.com/vi/-ky99iBljjw/hqdefault.jpg" alt="8.3 News" class="w-full h-full object-cover transition-transform duration-300 group-hover:scale-110" />
        </div>
        <div class="p-4">
          <h3 class="text-lg font-semibold text-white mb-1">CODM x HI3 Trailer 4</h3>
          <p class="text-slate-300 text-md">Kiana with akimbo
        </div>
      </a>
  
      <a href="https://youtu.be/Zk6XKgNOM8E" id="news3" target="blank" class="group block rounded-2xl bg-zinc-800 border border-zinc-600/50 hover:border-zinc-400 transition-colors duration-200 overflow-hidden">
        <div class="overflow-hidden h-48">
          <img src="https://i.ytimg.com/vi/Zk6XKgNOM8E/hqdefault.jpg" alt="Astral Ring" class="w-full h-full object-cover transition-transform duration-300 group-hover:scale-110" />
        </div>
        <div class="p-4">
          <h3 class="text-lg font-semibold text-white mb-1">HI3 10th Anni Rewards and Events</h3>
          <p class="text-slate-300 text-md">10 Years of Honkek</p>
        </div>
      </a>
