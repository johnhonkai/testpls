...
<svelte:head>
    <title>v9.1 Calendar and Boss Schedule</title> 
    <meta property="og:title" content="HI3 Calendar and Boss Schedule"/>
    <meta property="og:description" content="Version 9.1" />
    <meta property="og:image" content={data.ogImage} />
    <meta property="og:url" content="https://marisaimpact.com/valk/calendar91" />
...
<div class="flex justify-center items-end gap-5 -mt-3">
    ...
    <VersionSelect currentVersion="9.1"></VersionSelect>
...
<div class="p-4 container-screen-2xl flex justify-center items-center mt-4 ">
        ...
        <div class="overflow-x-auto ">
            <div class="w-[1350px]  bg-linear-to-b from-pink-500 to-pink-100 ">
                ...
                <div class="grid grid-cols-10 gap-2 text-center font-semibold bg-pink-900 text-white p-2  text-sm ">
                    ...
                    <div>WEEK 1<br/>Oct 22 - 30</div>
                    <div>WEEK 2<br/>Oct 30 - Nov 6</div>
                    <div>WEEK 3<br/>Nov 6 - 13</div>
                    <div>WEEK 4<br/>Nov 13 - 20</div>
                    <div>WEEK 5<br/>Nov 20 - 27</div>
                    <div>WEEK 6<br/>Nov 27 - Dec 4</div>
                    <div>WEEK 7<br/>Dec 4 - 11</div>
                    <div>WEEK 8<br/>Dec 11 - 18</div>
                    <div>WEEK 9<br/>Dec 18 - 24</div>
                ...
                <div class="relative grid grid-cols-10 gap-1  h-[54px] pe-1 overflow-x-clip ">
                    ...
                    <div on:click={() => openModal("")} class="col-span-6 rounded-lg will-change-transform transform transition-transform hover:scale-105 cursor-pointer relative my-0.5  bg-gray-100 text-black font-semibold text-center items-center justify-center border-2 border-pink-700">
                        ...
                        <!-- Centered Text -->
                        <span class="absolute inset-0 flex items-center justify-center z-10 leading-4">Herrscher of Time <br/> First ten pulls are free</span>
                        <div class="absolute right-0 top-1/2 transform -translate-y-1/2 w-25 h-full ">
                            <img src="/images/events/91/valk1.png" alt="Lone Planetfarer" class="w-full h-full object-cover rounded-lg" />
                        </div>
                    </div>  
                </div>
                ...
                <div class="relative grid grid-cols-10 gap-1  h-[54px] pe-1 overflow-x-clip">
                    ...
                    <div on:click={() => openModal("Equip")} class="rounded-lg will-change-transform transform transition-transform hover:scale-105 cursor-pointer relative my-0.5 col-span-6 bg-gray-100 text-black font-semibold text-center items-center justify-center border-2 border-pink-700">
                        ...
                        <!-- Centered Text -->
                        <span class="absolute inset-0 flex items-center justify-center z-10 leading-4">Herrscher of Time Equipment</span>
                ...
                <div class="relative grid grid-cols-10 gap-1  h-[54px] pe-1 overflow-x-clip ">
                    ...
                    <div on:click={() => openModal("")} class="col-span-3 rounded-lg will-change-transform transform transition-transform hover:scale-105 cursor-pointer relative my-0.5  bg-gray-100 text-black font-semibold text-center items-center justify-center border-2 border-pink-700">
                        ...
                        <!-- Centered Text -->
                        <span class="absolute inset-0 flex items-center justify-center z-10 leading-4">Wings of Panacea</span>
                        <div class="absolute right-0 top-1/2 transform -translate-y-1/2 w-25 h-full ">
                            <img src="/images/events/91/valk2.png" alt="Lone Planetfarer" class="w-full h-full object-cover rounded-lg" />
                        </div>
                    </div>    
                ...
                <div class="relative grid grid-cols-10 gap-1  h-[54px] pe-1 overflow-x-clip">
                    ...
                    <div on:click={() => openModal("Equip")} class="col-span-3 rounded-lg will-change-transform transform transition-transform hover:scale-105 cursor-pointer relative my-0.5  bg-gray-100 text-black font-semibold text-center items-center justify-center border-2 border-pink-700">
                        ...
                        <!-- Centered Text -->
                        <span class="absolute inset-0 flex items-center justify-center z-10 leading-4">Wings of Panacea Equipment</span>
 ...
 <div class="relative grid grid-cols-10 gap-1  h-[54px] pe-1 overflow-x-clip ">
                    ...
                    <div on:click={() => openModal("")} class="col-span-3 rounded-lg will-change-transform transform transition-transform hover:scale-105 cursor-pointer relative my-0.5  bg-gray-100 text-black font-semibold text-center items-center justify-center border-2 border-pink-700">
                        ...
                        <!-- Centered Text -->
                        <span class="absolute inset-0 flex items-center justify-left z-10 right-6 leading-4 pl-4">Supply Rotation</span>
                        <div class="absolute right-0 top-1/2 transform -translate-y-1/2 w-60 h-full ">
                            <img src="/images/events/91/carnival1.png" alt="Lone Planetfarer" class="w-full h-full object-cover rounded-lg" />
                        </div>
                    </div>    
                ...
                <div class="relative grid grid-cols-10 gap-1  h-[54px] pe-1 overflow-x-clip">
                    ...
                    <div on:click={() => openModal("Equip")} class="col-span-3 rounded-lg will-change-transform transform transition-transform hover:scale-105 cursor-pointer relative my-0.5  bg-gray-100 text-black font-semibold text-center items-center justify-center border-2 border-pink-700">
                        ...
                        <span class="absolute inset-0 flex items-center justify-left z-10 right-6 leading-4 pl-4">Supply Rotation</span>
                        <div class="absolute right-0 top-1/2 transform -translate-y-1/2 w-60 h-full ">
                            <img src="/images/events/91/carnival2.png" alt="Lone Planetfarer" class="w-full h-full object-cover rounded-lg" />
                        </div>
                ...
                <div class="relative grid grid-cols-10 gap-1  h-[54px] pe-1 overflow-x-clip">
                    ...
                    <div on:click={() => openModal("")} class="col-span-4 rounded-lg will-change-transform transform transition-transform hover:scale-105 cursor-pointer relative my-0.5  bg-gray-100 text-black font-semibold text-center items-center justify-center border-2 border-pink-700">
                        ...
                        <!-- Centered Text -->
                        <span class="absolute inset-0 flex items-center justify-center z-10 leading-4 ">Sena > Youyun > Chenxue > Theresa</span>
                    ...
                    <div on:click={() => openModal("")} class="col-span-2 rounded-lg will-change-transform transform transition-transform hover:scale-105 cursor-pointer relative my-0.5  bg-gray-100 text-black font-semibold text-center items-center justify-center border-2 border-pink-700">
                        ...
                        <!-- Centered Text -->
                        <span class="absolute inset-0 flex items-center justify-center z-10 leading-4 ">Senadina</span>
                ...
                <div class="relative grid grid-cols-10 gap-1  h-[54px] pe-1 overflow-x-clip">
                    ...
                    <div on:click={() => openModal("")} class="col-span-3 rounded-lg will-change-transform transform transition-transform hover:scale-105 cursor-pointer relative my-0.5  bg-gray-100 text-black font-semibold text-center items-center justify-center border-2 border-pink-700">
                        ...
                        <!-- Centered Text -->
                        <span class="absolute inset-0 flex items-center justify-center leading-4 ">Vow to Daybreak<br/> 9600 crystal</span>
                        <div class="absolute right-0 top-1/2 transform -translate-y-1/2 w-20 h-full ">
                            <img src="/images/events/91/outfit.png" alt="Lone Planetfarer" class="w-full h-full object-cover rounded-lg" />
                        </div>
                    </div>       
                    <div on:click={() => openModal("")} class="col-span-2 rounded-lg will-change-transform transform transition-transform hover:scale-105 cursor-pointer relative my-0.5  bg-gray-100 text-black font-semibold text-center items-center justify-center border-2 border-pink-700">
                        
                        <!-- Centered Text -->
                        <span class="absolute inset-0 flex items-center justify-center leading-4 ">Wintery Wishes<br/> 9600? crystal</span>
                        <div class="absolute right-0 top-1/2 transform -translate-y-1/2 w-15 h-full ">
                            <img src="/images/events/91/outfit2.png" alt="Lone Planetfarer" class="w-full h-full object-cover rounded-lg" />
                        </div>
                    </div>     
                    <div on:click={() => openModal("")} class="col-span-1 rounded-lg will-change-transform transform transition-transform hover:scale-105 cursor-pointer relative my-0.5  bg-gray-100 text-black font-semibold text-center items-center justify-center border-2 border-pink-700">
                        ...
                        <!-- Centered Text -->
                        <div class="absolute right-0 top-1/2 transform -translate-y-1/2 w-full h-full ">
                            <img src="/images/events/91/outfit3.png" alt="Lone Planetfarer" class="w-full h-full object-cover rounded-lg" />
                        </div>
                    </div>                                      
            ...
            <div class="relative grid grid-cols-10 gap-1 h-[54px] pe-1 overflow-x-clip">
                <div class="flex font-bold  text-zinc-800 bg-white border-b-[2px] border-slate-300 items-center justify-center text-center leading-4">
                    ...
                    <div on:click={() => openModal("")} class="col-span-6 rounded-lg will-change-transform transform transition-transform hover:scale-105 cursor-pointer relative my-0.5  bg-gray-100 text-black font-semibold text-center items-center justify-center border-2 border-pink-700">
                        ...
                        <div class="absolute right-0 top-1/2 transform -translate-y-1/2 w-80 h-full ">
                            <img src="/images/events/91/spending.png" alt="Lone Planetfarer" class="w-full h-full object-cover rounded" />
                        </div>
                    </div>   
            ...
            <div class="relative grid grid-cols-10 gap-1 h-[54px] pe-1 overflow-x-clip">
                <div class="flex font-bold  text-pink-600 bg-white border-b-[2px] border-slate-300 items-center justify-center text-center leading-4">
                    ...
                    <div on:click={() => openModal("")} class="col-span-9 rounded-lg will-change-transform transform transition-transform hover:scale-105 cursor-pointer relative my-0.5  bg-gray-100 text-black font-semibold text-center items-center justify-center border-2 border-pink-700">
                        <!-- Centered Text -->
                        <span class="absolute px-2.5 leading-4 inset-0 flex items-center justify-left">7-Day Login: 120 crystals, HoTime stigma box, and mats</span>
                        <!-- Image positioned on the right side -->
                        <div class="absolute right-0 top-1/2 transform -translate-y-1/2 w-40 h-full ">
                            <img src="/images/events/91/event1.png" alt="Lone Planetfarer" class="w-full h-full object-cover rounded" />
                        </div>
                    </div>   
            ...
            <div class="relative grid grid-cols-10 gap-1 h-[54px] pe-1 overflow-x-clip">
                <div class="flex font-bold  text-zinc-800 bg-white border-b-[2px] border-slate-300 items-center justify-center text-center leading-4">                   
                   ...
                   <span class="font-bold0">EVENT 3</span>
                    ...
                    <div on:click={() => openModal("")} class="col-span-6 rounded-lg will-change-transform transform transition-transform hover:scale-105 cursor-pointer relative my-0.5  bg-gray-100 text-black font-semibold text-center items-center justify-center border-2 border-pink-700">
                        <!-- Centered Text -->
                        <span class="absolute px-2.5 leading-4 inset-0 flex items-center justify-left">7-Day Login: Emblem, 10 Equip Card, Stigma Upgrade (cont from v9.0)</span>
                        <!-- Image positioned on the right side -->
                        <div class="absolute right-0 top-1/2 transform -translate-y-1/2 w-40 h-full ">
                            <img src="/images/events/91/event2.png" alt="Lone Planetfarer" class="w-full h-full object-cover rounded" />
                        </div>
                    </div>   
            </div>
            <div class="relative grid grid-cols-10 gap-1 h-[54px] pe-1 overflow-x-clip">
                <div class="flex font-bold  text-pink-600 bg-white border-b-[2px] border-slate-300 items-center justify-center text-center leading-4">
                    ...
                    <div on:click={() => openModal("")} class="col-span-6 rounded-lg will-change-transform transform transition-transform hover:scale-105 cursor-pointer relative my-0.5  bg-gray-100 text-black font-semibold text-center items-center justify-center border-2 border-pink-700">
                        <!-- Centered Text -->
                        <span class="absolute px-2.5 leading-4 inset-0 flex items-center justify-left">7-Day Login: 2 Equip Card (cont from v9.0)</span>
                        <!-- Image positioned on the right side -->
                        <div class="absolute right-0 top-1/2 transform -translate-y-1/2 w-40 h-full ">
             ...
             <div class="relative grid grid-cols-10 gap-1 h-[54px] pe-1 overflow-x-clip">
                <div class="flex font-bold  text-zinc-800 bg-white border-b-[2px] border-slate-300 items-center justify-center text-center leading-4">                   
                   ...
                   <span class="font-bold0">EVENT 5</span>
                    ...
                    <div on:click={() => openModal("")} class="col-span-9 rounded-lg will-change-transform transform transition-transform hover:scale-105 cursor-pointer relative my-0.5  bg-gray-100 text-black font-semibold text-center items-center justify-center border-2 border-pink-700">
                        <!-- Centered Text -->
                        <span class="absolute px-2.5 leading-4 inset-0 flex items-center justify-left">Free Thelema / Lantern / JDS Select + Anniversary Cake</span>
                        <!-- Image positioned on the right side -->
                        <div class="absolute right-0 top-1/2 transform -translate-y-1/2 w-40 h-full ">
                            <img src="/images/events/91/event3.png" alt="Lone Planetfarer" class="w-full h-full object-cover rounded" />
                        </div>
                    </div>   
             ...
             <div class="relative grid grid-cols-10 gap-1 h-[54px] pe-1 overflow-x-clip">
                <div class="flex font-bold  text-pink-600 bg-white border-b-[2px] border-slate-300 items-center justify-center text-center leading-4">
                    ...
                    <div on:click={() => openModal("")} class="col-span-9 rounded-lg will-change-transform transform transition-transform hover:scale-105 cursor-pointer relative my-0.5  bg-gray-100 text-black font-semibold text-center items-center justify-center border-2 border-pink-700">
                        <!-- Centered Text -->
                        <span class="absolute px-2.5 leading-4 inset-0 flex items-center justify-left">Free Weapon Select (v7.3-8.1 including DLC) ,  JD / Lantern / Thel Outfit Select and mats</span>
                        <!-- Image positioned on the right side -->
                        <div class="absolute right-0 top-1/2 transform -translate-y-1/2 w-40 h-full ">
                            <img src="/images/events/91/event8.png" alt="Lone Planetfarer" class="w-full h-full object-cover rounded" />
                        </div>
                    </div>     
            </div>   
<div class="relative grid grid-cols-10 gap-1 h-[54px] pe-1 overflow-x-clip">
                <div class="flex font-bold  text-zinc-800 bg-white border-b-[2px] border-slate-300 items-center justify-center text-center leading-4">                   
                   ...
                   <span class="font-bold0">EVENT 7</span>
                    ...
                    <div on:click={() => openModal("")} class="col-span-9 rounded-lg will-change-transform transform transition-transform hover:scale-105 cursor-pointer relative my-0.5  bg-gray-100 text-black font-semibold text-center items-center justify-center border-2 border-pink-700">
                        <!-- Centered Text -->
                        <span class="absolute px-2.5 leading-4 inset-0 flex items-center justify-left">Free 3 Time Capsule Box, 5 Mats Box</span>
                        <!-- Image positioned on the right side -->
                        <div class="absolute right-0 top-1/2 transform -translate-y-1/2 w-40 h-full ">
                            <img src="/images/events/91/event4.png" alt="Lone Planetfarer" class="w-full h-full object-cover rounded" />
                        </div>
                    </div>   
             ...
             <div class="relative grid grid-cols-10 gap-1 h-[54px] pe-1 overflow-x-clip">
                <div class="flex font-bold  text-pink-600 bg-white border-b-[2px] border-slate-300 items-center justify-center text-center leading-4">
                    ...
                    <div on:click={() => openModal("")} class="col-span-9 rounded-lg will-change-transform transform transition-transform hover:scale-105 cursor-pointer relative my-0.5  bg-gray-100 text-black font-semibold text-center items-center justify-center border-2 border-pink-700">
                        <!-- Centered Text -->
                        <span class="absolute px-2.5 leading-4 inset-0 flex items-center justify-left">Raffle (Merch, Valk Box, Weapon Box, BP Pass)</span>
                        <!-- Image positioned on the right side -->
                        <div class="absolute right-0 top-1/2 transform -translate-y-1/2 w-40 h-full ">
                            <img src="/images/events/91/event9.png" alt="Lone Planetfarer" class="w-full h-full object-cover rounded" />
                        </div>
                    </div>     
            </div>               
             <div class="relative grid grid-cols-10 gap-1 h-[54px] pe-1 overflow-x-clip">
                <div class="flex font-bold  text-zinc-800 bg-white border-b-[2px] border-slate-300 items-center justify-center text-center leading-4">                   
                   ...
                   <span class="font-bold0">EVENT 9</span>
                    ...
                    <div on:click={() => openModal("")} class="col-span-9 rounded-lg will-change-transform transform transition-transform hover:scale-105 cursor-pointer relative my-0.5  bg-gray-100 text-black font-semibold text-center items-center justify-center border-2 border-pink-700">
                        <!-- Centered Text -->
                        <span class="absolute px-2.5 leading-4 inset-0 flex items-center justify-left">Encounter♪ Memory of the Toy House</span>
                        <!-- Image positioned on the right side -->
                        <div class="absolute right-0 top-1/2 transform -translate-y-1/2 w-40 h-full ">
                            <img src="/images/events/91/event5.png" alt="Lone Planetfarer" class="w-full h-full object-cover rounded" />
                        </div>
                    </div>   
            ...
            <div class="relative grid grid-cols-10 gap-1 h-[54px] pe-1 overflow-x-clip">
                <div class="flex font-bold  text-pink-600 bg-white border-b-[2px] border-slate-300 items-center justify-center text-center leading-4">
                    ...
                    <div on:click={() => openModal("")} class="col-span-6 rounded-lg will-change-transform transform transition-transform hover:scale-105 cursor-pointer relative my-0.5  bg-gray-100 text-black font-semibold text-center items-center justify-center border-2 border-pink-700">
                        ...
                        <!-- Image positioned on the right side -->
                        <div class="absolute right-0 top-1/2 transform -translate-y-1/2 w-40 h-full ">
                            <img src="/images/events/91/event10.png" alt="Lone Planetfarer" class="w-full h-full object-cover rounded" />
                        </div>
                    </div>     
            </div>   
             ...
             <div class="relative grid grid-cols-20 gap-1 h-[54px] pe-1 overflow-x-clip">
                <div class="col-span-2 flex font-bold  text-zinc-800 bg-white border-b-[2px] border-slate-300 items-center justify-center text-center leading-4">                   
                   ...
                   <span class="font-bold ">EVENT 11</span>
                </div> 
                    <div></div>
                    <div on:click={() => openModal("")} class="col-span-17 rounded-lg will-change-transform transform transition-transform hover:scale-105 cursor-pointer relative my-0.5  bg-gray-100 text-black font-semibold text-center items-center justify-center border-2 border-pink-700">
                        <!-- Centered Text -->
                        <span class="absolute px-2.5 leading-4 inset-0 flex items-center justify-left">Anniversary Recap</span>
                        <!-- Image positioned on the right side -->
                        <div class="absolute right-0 top-1/2 transform -translate-y-1/2 w-40 h-full ">
                            <img src="/images/events/91/event11.png" alt="Lone Planetfarer" class="w-full h-full object-cover rounded" />
                        </div>
                    </div>   
             ...
             <div class="relative grid grid-cols-10 gap-1 h-[54px] pe-1 overflow-x-clip">
                <div class="flex font-bold  text-pink-600 bg-white border-b-[2px] border-slate-300 items-center justify-center text-center leading-4">
                    <span class="absolute w-[30px] h-[4px] bg-pink-600 inline-block top-[-3px] left-0"></span>
                     <span class="font-bold0">EVENT 12</span>
                </div> 
                <div></div>
                    <div on:click={() => openModal("")} class="col-span-8 rounded-lg will-change-transform transform transition-transform hover:scale-105 cursor-pointer relative my-0.5  bg-gray-100 text-black font-semibold text-center items-center justify-center border-2 border-pink-700">
                        <!-- Centered Text -->
                        <span class="absolute px-2.5 leading-4 inset-0 flex items-center justify-left">Free Sena / Luna and 15 Cards</span>
                        <!-- Image positioned on the right side -->
                        <div class="absolute right-0 top-1/2 transform -translate-y-1/2 w-40 h-full ">
                            <img src="/images/events/91/event6.png" alt="Lone Planetfarer" class="w-full h-full object-cover rounded" />
                        </div>
                    </div>     
            </div>   
             ...
             <div class="relative grid grid-cols-10 gap-1 h-[54px] pe-1 overflow-x-clip">
                <div class="flex font-bold  text-zinc-800 bg-white border-b-[2px] border-slate-300 items-center justify-center text-center leading-4">                   
                   ...
                   <span class="font-bold0">EVENT 13</span>
                </div> 
                    <div></div>
                    <div on:click={() => openModal("")} class="col-span-3 rounded-lg will-change-transform transform transition-transform hover:scale-105 cursor-pointer relative my-0.5  bg-gray-100 text-black font-semibold text-center items-center justify-center border-2 border-pink-700">
                        <!-- Centered Text -->
                        <span class="absolute px-2.5 leading-4 inset-0 flex items-center justify-left">Free 2 Carnival 10-Pull Cards</span>
                        <!-- Image positioned on the right side -->
                        <div class="absolute right-0 top-1/2 transform -translate-y-1/2 w-40 h-full ">
    ...
    <div class="overflow-x-auto overflow-y-clip">
        <div class="w-[940px] rounded-lg bg-gray-900 text-white" >
            ...
            <div class="grid grid-cols-6 gap-1 text-center font-semibold bg-gray-800 text-white p-2 rounded-t-lg">
                <div class="col-span-1 px-4 py-2 mr-3 ">v9.1 WEEK</div>
