...
<svelte:head>
    ...
    <link rel="canonical" href="https://marisaimpact.com/valk/calendar88" />
</svelte:head>
            ...
            <div class="w-[1215px]  bg-linear-to-b from-pink-500 to-pink-100 ">
                ...
                <div class="relative grid grid-cols-9 gap-1  h-[54px] pe-1 overflow-x-clip ">
                    ...
                    <div on:click={() => openModal("")} class="rounded-lg will-change-transform transform transition-transform hover:scale-105 cursor-pointer relative my-0.5 col-span-6 bg-gray-100 text-black font-semibold text-center items-center justify-center border-2 border-pink-700">
                        ...
                        <!-- Centered Text -->
                        <span class="absolute inset-0 flex items-center justify-center z-10 leading-4">Wings of Panacea<br/>First ten pulls are 50% off</span>
                    <!-- Image positioned on the right side -->
                     ...
                     <div on:click={() => openModal("")} class="rounded-lg will-change-transform transform transition-transform hover:scale-105 cursor-pointer relative my-0.5 col-span-2 bg-gray-100 text-black font-semibold text-center items-center justify-center border-2 border-pink-700">
                        ...
                        <div class="absolute right-0 top-1/2 transform -translate-y-1/2 w-15 h-full ">
                            <img src="https://i.imgur.com/gcU3nN9.png" alt="Lone Planetfarer" class="w-full h-full object-cover rounded-lg" />
                        </div>
                    </div> 
                </div>
    ...
    <div class="overflow-x-auto ">
            ...
            <div class="relative grid grid-cols-9 gap-1 h-[54px] pe-1 overflow-x-clip">
                <div class="flex font-bold  text-zinc-800 bg-white border-b-[2px] border-slate-300 items-center justify-center text-center leading-4">
                    ...
                    <div on:click={() => openModal("")} class="col-span-6 rounded-lg will-change-transform transform transition-transform hover:scale-105 cursor-pointer relative my-0.5  bg-gray-100 text-black font-semibold text-center items-center justify-center border-2 border-pink-700">
                     ...
                     <div on:click={() => openModal("")} class="col-span-2 rounded-lg will-change-transform transform transition-transform hover:scale-105 cursor-pointer relative my-0.5  bg-gray-100 text-black font-semibold text-center items-center justify-center border-2 border-pink-700">
                        <!-- Centered Text -->
                        <span class="absolute px-2.5 leading-4 inset-0 flex items-center justify-center">Puzzle Event</span>
            ...
            <div class="relative grid grid-cols-9 gap-1 h-[54px] pe-1 overflow-x-clip">
                <div class="flex font-bold  text-pink-600 bg-white border-b-[2px] border-slate-300 items-center justify-center text-center leading-4">
                    ...
                    <div></div>
                     <div on:click={() => openModal("")} class=" rounded-lg will-change-transform transform transition-transform hover:scale-105 cursor-pointer relative my-0.5  bg-gray-100 text-black font-semibold text-center items-center justify-center border-2 border-pink-700">
                        <!-- Centered Text -->
                        <span class="absolute px-2.5 leading-4 inset-0 flex items-center justify-center">Login<br/> 300 xtal</span>
            ...
            <div class="relative grid grid-cols-9 gap-1 h-[54px] pe-1 overflow-x-clip">
                <div class="flex font-bold  text-pink-600 bg-white border-b-[2px] border-slate-300 items-center justify-center text-center leading-4">
                    ...
                    <div on:click={() => openModal("")} class="col-span-5 rounded-lg will-change-transform transform transition-transform hover:scale-105 cursor-pointer relative my-0.5  bg-gray-100 text-black font-semibold text-center items-center justify-center border-2 border-pink-700">
                        <!-- Centered Text -->
                        <span class="absolute px-2.5 leading-4 inset-0 flex items-center justify-left">Snazzy Cards</span>
                        <!-- Image positioned on the right side -->
                        <div class="absolute right-0 top-1/2 transform -translate-y-1/2 w-40 h-full ">
                            <img src="https://i.imgur.com/WBrcx2o.png" alt="Lone Planetfarer" class="w-full h-full object-cover rounded" />
                        </div>
                    </div>   
    ...
    <div class="overflow-x-auto overflow-y-clip">
        <div class="w-[940px] rounded-lg bg-gray-900 text-white" >
            ...
            <div class="grid grid-cols-6 gap-1 items-center bg-slate-100 text pt-1 pb-1 pe-2 " >
                ...
                <div class="flex col-span-2 justify-center gap-1 mr-2" >
                <BossCard image="/images/Bosses/Raven.png" date="Jul 10" weather="Ice" bosspage="/boss?raven" />
                <BossCard image="/images/Bosses/Herrscher of the Void.webp" date="Jul 13" weather="Ignite" bosspage="/boss?ignitehov" />
                </div>
                     
                    <div class="flex col-span-3 justify-center gap-1 ml-2">
                <BossCard image="/images/Bosses/Ricecake.webp" date="Jul 14" />
            ...
            <div class="grid grid-cols-6 gap-1 items-center bg-slate-100 text pt-1 pb-1 pe-2 " >
                ...
                <div class="flex col-span-2 justify-center gap-1 mr-2" >
                <BossCard image="/images/Bosses/MOBIUS.png" date="Jul 31" weather="Bleed" bosspage="/boss?bleedmobius" />
                <BossCard image="/images/Bosses/Paros.png" date="Aug 3" weather="Extreme" bosspage="/boss?paros" />
                </div>
                     
                    <div class="flex col-span-3 justify-center gap-1 ml-2">
                <BossCard image="/images/Bosses/Husk - Nihilus_SSS.webp" date="Aug 4" />
            ...
            <div class="grid grid-cols-6 gap-1 items-center bg-slate-100 text pt-1 pb-1 pe-2 " >
                ...
                <div class="flex col-span-2 justify-center gap-1 mr-2" >
                <BossCard image="/images/Bosses/Imgpig.webp" date="Aug 7" weather="Lightning" bosspage="/boss?marut" />
                <BossCard image="/images/Bosses/Couatl Revenant.webp" date="Aug 10" weather="Resonance" bosspage="/boss?resocouatl" />
                </div>
                     
                    <div class="flex col-span-3 justify-center gap-1 ml-2">
                <BossCard image="/images/Bosses/Imgpig.webp" date="Aug 11" />
