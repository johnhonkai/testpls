    ...
    <div class="overflow-x-auto overflow-y-clip">
        <div class="w-[940px] rounded-lg bg-gray-900 text-white" >
            ...
            <div class="grid grid-cols-6 gap-1 items-center bg-slate-100 text pt-1 pb-1 pe-2 " >
                ...
                <div class="flex col-span-2 justify-center gap-1 mr-2" >
                <BossCard image="/images/Bosses/Mockery_Emperor.webp" date="Jan 24" weather="Flux" bosspage="/boss?momemperor" />
            ...
            <div class="grid grid-cols-6 gap-1 items-center bg-slate-100 text pt-1 pb-1 pe-2 " >
                ...
                <div class="flex col-span-3 justify-center gap-1 ml-2">
                    <BossCard image="/images/Bosses/Vita.png" date="Feb 11"/>
                    <BossCard image="/images/BossesMA/BOSS_260_3S.png" />
                    <BossCard image="/images/BossesMA/Dark Jixuanyuan (DXY).webp" />
                </div>
            ...
            <div class="grid grid-cols-6 gap-1 items-center bg-slate-100 text pt-1 pb-1 pe-2 " >
                ...
                <div class="flex col-span-2 justify-center gap-1 mr-2" >
                    <BossCard image="/images/Bosses/Herrscher of Rimestar.png" date="Feb 14" weather="Starless" bosspage="/boss?starrimestar" />
                    <BossCard image="/images/Bosses/Dominator of Wolves.webp" date="Feb 17" weather="Type" bosspage="/boss?typeandrius" />
                </div>
                 
                <div class="flex col-span-3 justify-center gap-1 ml-2">
                    <BossCard image="/images/Bosses/Meteor_Guaymas.webp" date="Feb 11"/>
