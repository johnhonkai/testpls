    ...
    <div class="overflow-x-auto ">
           ...
           <div class="relative grid grid-cols-20 gap-1 h-[54px] pe-1 overflow-x-clip">
                ...
                <div class="col-span-2"></div>
                    <div on:click={() => openModal("")} class="col-span-3 rounded-lg will-change-transform transform transition-transform hover:scale-105 cursor-pointer relative my-0.5  bg-gray-100 text-black font-semibold text-center items-center justify-center border-2 border-pink-700">
                        <!-- Centered Text -->
                        <span class="absolute px-2.5 leading-4 inset-0 flex items-center justify-left">Chibi Tournament</span>
             ...
             <div class="relative grid grid-cols-10 gap-1 h-[54px] pe-1 overflow-x-clip">
                <div class="flex font-bold  text-zinc-800 bg-white border-b-[2px] border-slate-300 items-center justify-center text-center leading-4">                   
                   ...
                   <span class="font-bold">EVENT 11</span>
                    ...
                    <div on:click={() => openModal("")} class=" rounded-lg will-change-transform transform transition-transform hover:scale-105 cursor-pointer relative my-0.5  bg-gray-100 text-black font-semibold text-center items-center justify-center border-2 border-pink-700">
                        <!-- Centered Text -->
                        <span class="absolute px-2.5 leading-4 inset-0 flex items-center justify-left">Thelema / Lantern / JD Selector</span>
    ...
    <div class="overflow-x-auto overflow-y-clip">
        <div class="w-[940px] rounded-lg bg-gray-900 text-white" >
            ...
            <div class="grid grid-cols-6 gap-1 items-center bg-slate-100 text pt-1 pb-1 pe-2 " >
                ...
                <div class="flex col-span-2 justify-center gap-1 mr-2" >
                <BossCard image="/images/Bosses/Hellmaru.webp" date="Oct 16" weather="Ice" bosspage="/boss?hellmaru" />
                <BossCard image="/images/Bosses/JizoMitama.webp" date="Oct 19" weather="Physical" bosspage="/boss?jizo" />
                </div>

                    <div class="flex col-span-3 justify-center gap-1 ml-2">
                <BossCard image="/images/BossesMA/Husk - Existentialism_SSS.webp" date="Oct 20" />
