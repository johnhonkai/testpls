...
<div class="container mx-auto py-10 flex flex-row justify-center">
	...
	<article class="prose grow  mx-auto max-w-[960px] p-6 bg-zinc-800 rounded-lg shadow-md space-y-5 prose-ul:leading-6 prose-h3:bg-gradient-to-r from-cyan-700 to-cyan-500 prose-h3:text-black prose-h3:pl-2 prose-h3:rounded prose-h1:custom-font ">
		<h1>{data.title}</h1>
