...
<div class="p-4 container-screen-2xl flex justify-center items-center mt-4">
        ...
        <div class="overflow-x-auto ">
            <div class="w-[940px] rounded-lg bg-linear-to-b from-rose-500 to-rose-100 ">
                <!-- Calendar Header Row -->
                ...
                <div class="relative grid grid-cols-7 gap-1  h-[55px] pe-1 overflow-x-clip">
                    ...
                    <div on:click={() => openModal("JD")} class=" will-change-transform transform transition-transform hover:scale-105 cursor-pointer relative my-0.5 col-span-2 bg-gray-100 text-black font-semibold text-center items-center justify-center border-2 border-rose-700">
                        <!-- Centered Text -->
    ...
    <div class="overflow-x-auto overflow-y-clip">
        <div class="w-[940px] rounded-lg bg-gray-900 text-white" >
            ...
            <div class="grid grid-cols-6 gap-1 items-center bg-slate-100 text pt-1 pb-1 pe-2 " >
                ...
                <BossCard image="/images/Bosses/Swarm.webp" date="Dec 2" weather="Blood" bosspage="/boss?bloodsdmob"/>
                </div>
            ...
            <div class="grid grid-cols-6 gap-1 items-center bg-slate-100 text pt-1 pb-1 pe-2">
                ...
                <div class="flex col-span-2 justify-center gap-1 mr-2">
                    <BossCard image="/images/Bosses/Flame-Chaser - Vill-V.webp" date="Jan 3" weather="Bleed" bosspage="/boss?villv"/>
                    <BossCard image="/images/Bosses/Raven.png" date="Jan 6" weather="Ice" bosspage="/boss?raven"/>
                    </div>
                     
                    <div class="flex col-span-3 justify-center gap-1 ml-2">
                        <BossCard image="/images/Bosses/Sprout_of_Wishing_SSS.webp" date="Jan 7"/>
                        <BossCard image="/images/Bosses/Aesir Heimdall_SSS.webp"/>
