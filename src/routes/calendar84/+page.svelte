    ...
    <div class="overflow-x-auto ">
        <div class="w-[1350px]  bg-linear-to-b from-rose-500 to-rose-100 ">
            ...
            <div class="relative grid grid-cols-10 gap-1 h-[55px] pe-1 overflow-x-clip">
                ...
                <div on:click={() => openModal("")} class="col-span-6 will-change-transform transform transition-transform hover:scale-105 ease-linear cursor-pointer relative my-0.5  bg-gray-100 text-black font-semibold text-left items-center justify-center border-2  border-rose-700">
                    <!-- Centered Text -->
                    <span class="absolute px-2.5 leading-4 inset-0 flex items-center justify-left">Homu Fall Girls</span>
                    <!-- Image positioned on the right side -->
                    <div class="absolute right-0 top-1/2 transform -translate-y-1/2 w-48 h-full">
                        <img src="https://i.imgur.com/YP5VM3p.png" alt="Event 1" class="w-full h-full object-cover " />
                    </div>
                </div>
    ...
    <div class="overflow-x-auto overflow-y-clip">
        <div class="w-[940px] rounded-lg bg-gray-900 text-white" >
            ...
            <div class="grid grid-cols-6 gap-1 items-center bg-slate-100 text pt-1 pb-1 pe-2 " >
                ...
                <BossCard image="/images/Bosses/Lantern_Tsavorae_SSS.webp" date="Aug 25" weather="Flux" bosspage="/boss?lantern" />
                </div>
                     
                    <div class="flex col-span-3 justify-center gap-1 ml-2">
                        <BossCard image="/images/Bosses/Litost.webp" date="Aug 26"/>
            ...
            <div class="grid grid-cols-6 gap-1 items-center bg-slate-100 text pt-1 pb-1 pe-2 " >
                ...
                <BossCard image="/images/Bosses/Herrscher of Ice.webp" date="Sep 15" weather="Ignite" bosspage="/boss?hoice" />
                </div>
                     
                    <div class="flex col-span-3 justify-center gap-1 ml-2">
                        <BossCard image="/images/Bosses/Litost.webp" date="Sep 16"/>
            ...
            <div class="grid grid-cols-6 gap-1 items-center bg-slate-100 text pt-1 pb-1 pe-2 " >
                ...
                <BossCard image="/images/Bosses/Varaha.png" date="Sep 29" weather="Quantum" bosspage="/boss?quavalralhal" />
                </div>
            ...
            <div class="grid grid-cols-6 gap-1 items-center bg-slate-100 text pt-1 pb-1 pe-2 " >
                ...
                <BossCard image="/images/Bosses/Alien%20Guard.webp" date="Oct 6" weather="Physical" bosspage="/boss?phyalien" />
                </div>
                     
                    <div class="flex col-span-3 justify-center gap-1 ml-2">
                        <BossCard image="/images/Bosses/Litost.webp" date="Oct 7"/>
            ...
            <div class="grid grid-cols-6 gap-1 items-center bg-slate-100 text pt-1 pb-1 pe-2 " >
                ...
                <BossCard image="/images/Bosses/Herrscher of Rimestar.png" date="Oct 13" weather="Starless" bosspage="/boss?starrimestar" />
                </div>
                     
                    <div class="flex col-span-3 justify-center gap-1 ml-2">
                        <BossCard image="/images/Bosses/Meteor_Guaymas_SSS.webp" date="Oct 14"/>
