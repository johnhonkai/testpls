<script lang="ts">
    ...
    const mainCharacters = [
        ...
        { name: 'Xentinel', image: '/images/valkportrait/Mei Xentinel.png',  teampct: '100%'},
        { name: 'PS', image: '/images/valkportrait/ps.png',  teampct: '98++' },
        { name: 'PAWS', image: '/images/valkportrait/paws.png',  teampct: '97%'},
        { name: 'HLE', image: '/images/valkportrait/Elysia Hi Love Elf.png',  teampct: '91%' },
        { name: 'Badum', image: '/images/valkportrait/kiana badum.png',  teampct: '89%' },
        { name: 'HoH', image: '/images/valkportrait/Elysia Herrscher of Human Ego.png',  teampct: '88%' },
        { name: 'HoRB', image: '/images/valkportrait/Seele Herrscher of Rebirth.png',  teampct: '81%'},
...
<div class="mb-8 mt-8 border rounded-lg bg-linear-to-b from-red-950 to-red-900 shadow-lg shadow-base-100 overflow-hidden">
    <h3 class="text-xl font-semibold mb-2 text-center text-zinc-900 bg-slate-100 font-s">Lunar Vow DLC DPS</h3>

    <div class="flex flex-wrap px-2 pt-2 gap-2 gap-y-6 mb-4 justify-center">

        <!-- Leader Image -->
        <div class="relative w-20 h-20 sm:w-28 sm:h-28">
            <img src="/images/valkportrait/Theresa Lunar Vow.png" alt="badum" class="w-full h-full object-cover">
...
<details class="group rounded-md my-2 overflow-hidden">
        ...
        <div class="py-3 px-4">
             ...
             <p class="text-sm sm:text-base mb-4">
                Luna's best teammates are usually BFD, Xentinel and Peregrine Sword.
            </p>

            <p class="text-sm sm:text-base mb-4"><b>Peregrine Sword</b><br/> Provides Bleed DMG buff and Bleed-related advantage, which is especially useful in Bleed weather.
