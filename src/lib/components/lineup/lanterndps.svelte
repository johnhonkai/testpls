<script lang="ts">
    ...
    const mainCharacters = [
        ...
        { name: 'JD', image: '/images/valkportrait/Songque Jovial Deception.png', teampct: '76%', speed: '' },
        { name: 'Thelema', image: '/images/valkportrait/Thelema Mad Pleasure.png', teampct: '75%', speed: '' },
...
<div class="mb-8 mt-8 border rounded-lg bg-linear-to-b from-pink-950 to-pink-900   shadow-lg shadow-base-100 overflow-hidden  ">
    ...
    <details class="group rounded-md my-2 overflow-hidden">
        ...
        <p class="text-sm sm:text-base mb-4"><b>Thelema</b>
            ...
            Shieldbreak is a game-changer against Kasumi. Evasion spam AR regen is used on multiple bosses: RPC, Tank, Mobius. 
