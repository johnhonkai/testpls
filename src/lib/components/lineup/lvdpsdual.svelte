<script lang="ts">
    ...
    const mainCharacters = [
        ...
        { name: 'Eden', image: '/images/valkportrait/Eden Golden Diva.png', teampct: '100%', speed: '' }
    ];
...
<div class="mb-8 mt-8 border rounded-lg bg-linear-to-b from-red-950 to-red-900 shadow-lg shadow-base-100 overflow-hidden">
    <h3 class="text-xl font-semibold mb-2 text-center text-zinc-900 bg-slate-100 font-s">Luna x SIMP Double DPS</h3>
    ...
    <details class="group rounded-md my-2 overflow-hidden">
        ...
        <div class="py-3 px-4">
            <p class="text-sm sm:text-base">
                <li class="text-sm sm:text-base">SIMP buffs Lunar Vow, Lunar Vow buffs SIMP. SIMP deals big dmg, Lunar Vow also deals big dmg.</li>
                <li class="text-sm sm:text-base">This team has been used against Starless Benares and Paralyze Sushang in v7.7.</li>
            </p>
        </div>
    </details>
</div>
