<script lang="ts">
    ...
    const mainCharacters = [
        { name: 'LV', image: '/images/valkportrait/Theresa Lunar Vow.png', teampct: '100%', speed: '' },
    ...
    export let firstCharName: string = 'LV'; // default to 'Vita'
    export let secondCharName: string = 'Simp';
