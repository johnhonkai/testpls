<script lang="ts">
    ...
    const mainCharacters = [
        ...
        { name: 'RS', image: '/images/valkportrait/dudu.png', utility: 'Shield',},
    ...
    const asopchar = [
        ...
        { name: 'Elysia', image: '/images/valkportrait/elf_ely.png',  },
...
<div class="mb-8 mt-8 border rounded-lg bg-linear-to-b from-pink-950 to-pink-900 shadow-lg shadow-base-100 overflow-hidden">
    <h3 class="text-xl font-semibold mb-2 text-center text-zinc-900 bg-slate-100 font-s">嗨♪爱愿妖精♥ DPS</h3>

    <div class="flex flex-wrap px-2 pt-2 gap-2 gap-y-6 mb-4 justify-center">

        <!-- Leader Image -->
        <div class="relative w-20 h-20 sm:w-28 sm:h-28">
            <img src="/images/valkportrait/Elysia Messenger of Love.png" alt="badum" class="w-full h-full object-cover">
