...
<div class="mb-8 mt-8 border rounded-lg bg-gradient-to-b from-red-950 to-red-900 shadow-lg shadow-base-100 overflow-hidden">
    <h3 class="text-xl font-semibold mb-2 text-center text-zinc-900 bg-slate-100 font-s">Sparkle DPS</h3>

    <div class="flex flex-wrap px-2 pt-2 gap-2 gap-y-6 mb-4 justify-center">

        <!-- Leader Image -->
        <div class="relative w-20 h-20 sm:w-28 sm:h-28">
            <img src="/images/valkportrait/sparkle.png" alt="SIMP" class="w-full h-full object-cover">
    ...
    <details class="group rounded-md my-2 overflow-hidden">
        ...
        <div class="py-3 px-4">
            <p class="text-sm sm:text-base">
                ...
                <li class="text-sm  sm:text-base mt-4">Sparkle DPS's strongest and fastest team is Vita + HoFi. (Data based on 7.9 Resonance Vita) , but in Red Lotus where enemies die faster, other supports like Senadina and Thelema are close, or maybe better.</li>
                <li class="text-sm sm:text-base mt-4">Senadina: Senadina also provides Breach, and when paired with Songque AstralOp, you gain +25 more initial AR. </li>
                <li class="text-sm sm:text-base mt-4">Lantern: Her high-hitcount attacks can counter Fire Kosma. Lantern + Vita / HoFi / Sena are in CN Top 100 (Data based on 7.9 Fire Kosma)</li>
