<script lang="ts">
    ...
    const mainCharacters = [
        ...
        { name: 'Pardo', image: '/images/valkportrait/Pardofelis Reverist Calico.png',  speed: '' },
    ];
    ...
    export let firstCharName: string = 'Kira'; // default to 'Vita'
    export let secondCharName: string = 'Pardo';
...
<div class="mb-8 mt-8 border rounded-lg bg-gradient-to-b from-blue-950 to-blue-900 shadow-lg shadow-base-100 overflow-hidden">
    ...
    <div class="flex flex-wrap px-2 pt-2 gap-2 gap-y-6 mb-4 justify-center">
        ...
        <div class="relative w-20 h-20 sm:w-28 sm:h-28">
            <img src="/images/valkportrait/Sushang Jade Knight.png" alt="LV" class="w-full h-full object-cover">
        </div>
        ...
        <div class="py-3 px-4">
            <p class="text-sm sm:text-base mb-3">A fully farmable 3-support ice team. Can act as a decent Ice DPS until you get a better one.
             </p>
        </div>
