 ...
 // Valkyrie character data with type, element, and astral ring properties
  ...
  { name: '愈生佑翎', image: '/images/valkportrait/89Seele.png', type: ['SD' , 'Qua'], element: 'Lightning', astralRing: ['World Star'] , url: '/valk/89seele', badge: 'Beta', verdebut: 8.9, verdlc: 8.8, id:75},
